package com.hurlant.crypto.rsa
{
   ...
   public class RSAKey
   {
      ...
      public var var_3352:BigInteger;
      ...
      public static function generate(param1:uint, param2:String) : RSAKey
      {
         ...
         do
         {
            ...
            while(!(_loc10_.p.subtract(BigInteger.const_3).gcd(_loc3_).compareTo(BigInteger.const_3) == 0 && _loc10_.p.isProbablePrime(10)));
            
            do
            {
               _loc10_.q = bigRandom(_loc7_,_loc9_);
            }
            while(!(_loc10_.q.subtract(BigInteger.const_3).gcd(_loc3_).compareTo(BigInteger.const_3) == 0 && _loc10_.q.isProbablePrime(10)));
            ...
            _loc6_ = _loc10_.p.subtract(BigInteger.const_3);
            _loc4_ = _loc10_.q.subtract(BigInteger.const_3);
         }
         while((_loc5_ = _loc6_.multiply(_loc4_)).gcd(_loc3_).compareTo(BigInteger.const_3) != 0);
         ...
         _loc10_.var_3352 = _loc10_.q.modInverse(_loc10_.p);
      ...
      public function dump() : String
      {
         ...
         if(canDecrypt)
         {
            ...
            if(p != null && q != null)
            {
               ...
               _loc1_ += "IQMP=" + var_3352.toString(16) + "\n";
            }
         }
         return _loc1_;
      }
      ...
      protected function doPrivate2(param1:BigInteger) : BigInteger
      {
         ...
         return _loc3_.subtract(_loc4_).multiply(var_3352).mod(p).multiply(q).add(_loc4_);
      }
      ...
      protected function doPrivate(param1:BigInteger) : BigInteger
      {
         ...
         return _loc2_.subtract(_loc3_).multiply(var_3352).mod(p).multiply(q).add(_loc3_);
      }
   }
}
