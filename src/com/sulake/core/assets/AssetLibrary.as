package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcherWrapper implements IAssetLibrary
   {
      ...
      private static var var_954:com.sulake.core.assets.class_67 = new com.sulake.core.assets.class_67();
      
      private static const USE_LAZY_ASSET_PROCESSOR:Boolean = false;
      
      private static var var_214:uint = 0;
      ...
      private var var_106:String;
      
      private var var_62:XML;
      
      private var var_105:Boolean;
      
      private var var_48:uint;
      
      private var var_16:class_39;
      
      private var var_101:Class;
      
      private var var_168:Dictionary;
      
      private var var_36:Dictionary;
      
      private var var_139:Boolean = true;
      ...
      public function AssetLibrary(param1:String, param2:XML = null)
      {
         ...
         var_91 = new Dictionary(false);
         var_168 = new Dictionary(false);
         var_36 = new Dictionary(false);
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class, param4:FZip = null) : Boolean
      {
         ...
         {
            throw new Error("Library " + param1.var_106 + " doesn\'t contain valid resource class!");
         }
         var _loc6_:XMLList;
      ...
      {
         if(var_106 == param1.url && var_105)
         {
            if(!var_139 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,var_62,var_101);
            }
            var_139 = param2;
      ...
      public function unload() : void
      {
         ...
         for(_loc2_ in var_91)
         {
            _loc1_ = var_91[_loc2_];
            _loc1_.assetLoader.dispose();
            delete var_91[_loc2_];
         }
         for(_loc2_ in var_36)
         {
            _loc3_ = var_36[_loc2_];
            _loc3_.dispose();
            delete var_36[_loc2_];
         }
         for(_loc2_ in var_168)
         {
            delete var_168[_loc2_];
         }
         if(var_16 != null)
         {
            var_16.dispose();
      ...
      {
         var _loc2_:Class = var_168[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null, param4:int = -1) : AssetLoaderStruct
      {
         ...
         if((_loc5_ = var_91[param2.url]) != null)
         {
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc2_:AssetLoaderStruct = var_91[_loc4_.url];
         if(_loc2_ == null)
         {
         ...
         switch(param1.type)
         {
            case "AssetLoaderEventComplete":
               ...
               if(_loc3_ != null)
               {
                  ...
                  var_36[_loc2_.assetName] = _loc6_;
                  break;
               }
               param1 = new AssetLoaderEvent("AssetLoaderEventError",param1.status);
               break;
      ...
      {
         var _loc2_:IAsset = var_36[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      {
         return var_101 != null ? false : false;
      }
      ...
      private function libraryLoadedHandler(param1:class_43) : void
      {
         ...
         var_62 = _loc2_.manifest.copy();
         var_101 = _loc2_.resource;
         var_106 = _loc2_.url;
         if(var_139)
         {
            AssetLibrary.fetchLibraryContents(this,var_62,var_101);
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc7_:XMLList;
         if((_loc7_ = var_62.child("library")) == null)
         {
            throw new Error("Provided manifest doesn\'t contain library node!");
         }
         if(_loc7_.length() == 0)
            ...
            if((_loc7_ = _loc7_.child("asset")) != null)
            {
               ...
               while(_loc6_ < _loc5_)
               {
                  ...
                  if(_loc2_.attribute("name") && _loc2_.attribute("name").toString() == param1)
                  {
                     ...
                     if(_loc3_ == null)
                     {
                        throw new Error("Failed to extract asset " + param1 + " from Library " + var_106 + "!");
                     }
                     (_loc8_ = new _loc3_.assetClass(_loc3_) as IAsset).setUnknownContent(var_101[param1]);
