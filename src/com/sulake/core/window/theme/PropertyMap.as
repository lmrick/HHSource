package com.sulake.core.window.theme
{
   ...
   public class PropertyMap implements class_3302
   {
      ...
      {
         var_2783[param1] = new PropertyStruct(param1,param2,param3,false,param4);
      }
      ...
      {
         return var_2783[param1];
      }
      
      public function clone() : PropertyMap
      {
         var _loc1_:PropertyMap = new PropertyMap();
         for(var _loc2_ in var_2783)
         {
            _loc1_.var_2783[_loc2_] = var_2783[_loc2_];
         }
         return _loc1_;
      }
   }
