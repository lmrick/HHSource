package com.sulake.core.window.components
{
   ...
   public class SelectableButtonController extends ButtonController implements ISelectableWindow
   {
      ...
      public function SelectableButtonController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:class_3127, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
            ...
            if(_parent)
            {
               if(!(_parent is ISelectorWindow))
               {
                  ...
                  while(_loc3_)
                  {
                     ...
                     {
                        _loc4_ = class_3134.allocate("WE_CHILD_ACTIVATED",this,null);
      ...
      public function select() : Boolean
      {
         ...
         var _loc1_:class_3134 = class_3134.allocate("WE_SELECT",this,null,true);
         update(this,_loc1_);
         ...
         _loc1_.recycle();
         setStateFlag(8,true);
         _loc1_ = class_3134.allocate("WE_SELECTED",this,null);
         update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function unselect() : Boolean
      {
         ...
         var _loc1_:class_3134 = class_3134.allocate("WE_UNSELECT",this,null,true);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = class_3134.allocate("WE_UNSELECTED",this,null);
         update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
