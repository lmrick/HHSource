package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      public static const const_477:String = "focused";
      
      public static const WINDOW_STATE_HOVERING:String = "hovering";
      
      public static const const_489:String = "selected";
      
      public static const const_456:String = "pressed";
      
      public static const const_479:String = "disabled";
      
      public static const const_476:String = "locked";
      ...
      public static function parseSkinDescription(param1:XML, param2:XMLList, param3:ISkinRenderer, param4:String, param5:class_21) : void
      {
         var _loc8_:XML = null;
         ...
         if((_loc12_ = param1.child("variables")).length() > 0)
         {
            ...
            {
               class_3307.parseVariableList(_loc10_,_loc6_);
            }
         }
      ...
      protected static function parseLayout(param1:ISkinRenderer, param2:XML, param3:Dictionary, param4:class_24) : void
      {
      ...
      protected static function parseLayoutList(param1:ISkinRenderer, param2:XML, param3:Dictionary, param4:class_24) : void
      {
         var _loc6_:* = 0;
         var _loc8_:XML = null;
         var _loc7_:XMLList;
      ...
      protected static function parseLayoutEntity(param1:XML, param2:class_24) : SkinLayoutEntity
      {
      ...
      protected static function parseLayoutEntityList(param1:ISkinRenderer, param2:SkinLayout, param3:XMLList, param4:class_24) : void
      {
      ...
      protected static function parseTemplateList(param1:ISkinRenderer, param2:XML, param3:Dictionary, param4:class_24, param5:class_21) : void
      {
         var _loc9_:* = 0;
      ...
      protected static function parseTemplateEntityList(param1:ISkinRenderer, param2:BitmapSkinTemplate, param3:XMLList, param4:class_24) : void
      {
         var _loc10_:XML = null;
         var _loc15_:XMLList = null;
         ...
         while(_loc8_ < _loc5_)
         {
            _loc12_ = String((_loc6_ = (_loc10_ = param3[_loc8_]).attribute("name")).charAt(0) == "$" ? param4[_loc6_.slice(1,_loc6_.length)] : _loc6_);
            _loc9_ = String((_loc6_ = _loc10_.attribute("type")).charAt(0) == "$" ? param4[_loc6_.slice(1,_loc6_.length)] : _loc6_);
            _loc13_ = uint((_loc6_ = _loc10_.attribute("id")).charAt(0) == "$" ? param4[_loc6_.slice(1,_loc6_.length)] : _loc6_);
      ...
      protected static function parseState(param1:ISkinRenderer, param2:XML, param3:Dictionary, param4:class_24) : void
      {
         var _loc6_:XML = null;
         ...
         var _loc12_:String;
         if((_loc12_ = param2.attribute("name")).charAt(0) == "$")
         {
            _loc12_ = String(param4[_loc12_.slice(1,_loc12_.length)]);
         }
         var _loc11_:String;
         if((_loc11_ = param2.attribute("layout")).charAt(0) == "$")
         {
            _loc11_ = String(param4[_loc11_.slice(1,_loc11_.length)]);
         }
         var _loc5_:String;
         if((_loc5_ = param2.attribute("template")).charAt(0) == "$")
         {
            _loc5_ = String(param4[_loc5_.slice(1,_loc5_.length)]);
         }
         var _loc8_:ISkinLayout;
         if((_loc8_ = param3[_loc11_]) == null)
         {
            throw new Error("State " + _loc12_ + " has invalid layout reference " + _loc11_ + "!");
         }
         var _loc9_:XMLList;
         if((_loc9_ = param2.child("variables")).length() > 0)
         {
            if((_loc7_ = (_loc6_ = _loc9_[0]).child("variable")).length())
            {
               _loc10_ = new class_24();
               class_3307.parseVariableList(_loc7_,_loc10_);
               for(_loc15_ in _loc10_)
               {
                  if((_loc14_ = _loc10_[_loc15_]) is String)
                  {
      ...
      protected static function parseRenderStateList(param1:ISkinRenderer, param2:XML, param3:Dictionary, param4:class_24) : void
      {
         var _loc7_:* = 0;
         var _loc6_:XMLList;
