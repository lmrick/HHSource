package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinLayout extends ChildEntityArray implements ISkinLayout
   {
      ...
      protected var var_3601:String;
      
      protected var var_3870:Boolean;
      ...
      override public function addChild(param1:class_3257) : class_3257
      {
         var _loc2_:SkinLayoutEntity = SkinLayoutEntity(param1);
         _width = _loc2_.region.right > _width ? _loc2_.region.right : _width;
         var_47 = _loc2_.region.bottom > var_47 ? _loc2_.region.bottom : var_47;
         return super.addChild(param1);
      }
      
      override public function addChildAt(param1:class_3257, param2:int) : class_3257
      {
         var _loc3_:SkinLayoutEntity = SkinLayoutEntity(param1);
         _width = _loc3_.region.right > _width ? _loc3_.region.right : _width;
         var_47 = _loc3_.region.bottom > var_47 ? _loc3_.region.bottom : var_47;
         return super.addChildAt(param1,param2);
      }
      
      override public function removeChild(param1:class_3257) : class_3257
      {
         super.removeChild(param1);
         _width = calculateWidth();
         var_47 = calculateHeight();
         return param1;
      }
      
      override public function removeChildAt(param1:int) : class_3257
      {
         var _loc2_:class_3257 = super.removeChildAt(param1);
         _width = calculateWidth();
         var_47 = calculateHeight();
         return _loc2_;
      }
