package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_1849:Dictionary;
      
      protected var _layoutsByName:Dictionary;
      
      protected var var_1975:Dictionary;
      ...
      public function SkinRenderer(param1:String)
      {
         ...
         var_1849 = new Dictionary();
         _layoutsByName = new Dictionary();
         var_1975 = new Dictionary();
      }
      ...
      public function parse(param1:IAsset, param2:XMLList, param3:class_21) : void
      {
      }
      ...
      public function draw(param1:class_3127, param2:BitmapData, param3:Rectangle, param4:uint, param5:Boolean) : void
      {
      }
      ...
      public function removeLayout(param1:ISkinLayout) : ISkinLayout
      {
         ...
         if(param1 != null)
         {
            for(_loc3_ in var_1975)
            {
               _loc2_ = _loc3_ as uint;
               if(var_1975[_loc2_] == param1)
               {
      ...
      public function removeTemplate(param1:ISkinTemplate) : ISkinTemplate
      {
         ...
         if(param1 != null)
         {
            for(_loc3_ in var_1849)
            {
               _loc2_ = _loc3_ as uint;
               if(var_1849[_loc2_] == param1)
               {
