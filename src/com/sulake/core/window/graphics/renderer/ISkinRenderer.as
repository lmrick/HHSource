package com.sulake.core.window.graphics.renderer
{
   ...
   public interface ISkinRenderer extends class_13
   {
      ...
      function parse(param1:IAsset, param2:XMLList, param3:class_21) : void;
      
      function draw(param1:class_3127, param2:BitmapData, param3:Rectangle, param4:uint, param5:Boolean) : void;
