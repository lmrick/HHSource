package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements class_3337
   {
      ...
      public static const const_766:String = "_TEMP";
      ...
      private static const const_686:String = "dynamic_style";
      ...
      private static const const_560:String = "y";
      ...
      private static const const_1039:String = "width_max";
      
      private static const HEIGHT_MIN:String = "height_min";
      
      private static const const_586:String = "height_max";
      ...
      private static const const_443:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_2903:Dictionary;
      
      protected var var_2984:Dictionary;
      
      protected var var_2650:Dictionary;
      
      protected var var_3195:Dictionary;
      
      protected var _parsedLayoutCache:class_24;
      
      protected var _context:class_3178;
      
      private var _disposed:Boolean = false;
      
      public function WindowParser(param1:class_3178)
      {
         super();
         _context = param1;
         var_2903 = new Dictionary();
         var_2984 = new Dictionary();
         class_3400.fillTables(var_2903,var_2984);
         var_2650 = new Dictionary();
         var_3195 = new Dictionary();
         class_3439.fillTables(var_2650,var_3195);
         _parsedLayoutCache = new class_24();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_443,"");
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            for(_loc1_ in var_2903)
            {
               delete var_2903[_loc1_];
            }
            for(_loc1_ in var_2984)
            {
               delete var_2984[_loc1_];
            }
            for(_loc1_ in var_2650)
            {
               delete var_2650[_loc1_];
            }
            for(_loc1_ in var_3195)
            {
               delete var_3195[_loc1_];
            }
      ...
      public function parseAndConstruct(param1:XML, param2:class_3127, param3:class_24) : class_3127
      {
         var _loc6_:* = 0;
         ...
         if(param1.localName() == "layout")
         {
            if((_loc9_ = param1.child("variables")).length() > 0)
            {
               ...
               if((_loc7_ = XML(_loc5_[0]).children()).length() > 0)
               {
                  ...
                  class_3307.parseVariableList(_loc7_,param3);
               }
            }
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:class_24) : class_3127
      {
         var _loc9_:* = 0;
         ...
         if((_loc21_ = param1.child("children")).length() > 0)
         {
            ...
            if(_loc29_ is class_3399)
            {
               class_3399(_loc29_).setAutoRearrange(false);
            }
            _loc18_ = 0;
            while(_loc18_ < _loc17_)
            {
         ...
         if(_loc29_ is class_3399)
         {
            class_3399(_loc29_).setAutoRearrange(true);
         }
         return _loc29_;
      }
      ...
      private function parseAttribute(param1:XML, param2:String, param3:class_24, param4:Object) : Object
      {
         var _loc5_:XMLList;
      ...
      public function windowToXMLString(param1:class_3127) : String
      {
         ...
         if(_loc16_ is IIterable)
         {
            if((_loc5_ = (_loc10_ = IIterable(_loc16_).iterator).length) > 0)
            {
               ...
               while(_loc6_ < _loc5_)
               {
                  if((_loc17_ = _loc10_[_loc6_] as class_3127).tags.indexOf("_EXCLUDE") == -1)
                  {
