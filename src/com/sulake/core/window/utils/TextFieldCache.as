package com.sulake.core.window.utils
{
   ...
   public class TextFieldCache implements class_13
   {
      ...
      private static var _textFieldCache:class_24 = new class_24();
      
      private static var var_42:com.sulake.core.window.utils.TextFieldCache = new com.sulake.core.window.utils.TextFieldCache();
      ...
      public static function getTextFieldByStyle(param1:class_3367) : TextField
      {
         ...
         if(!param1)
         {
            param1 = class_3388.getStyle("regular");
         }
         ...
         _loc2_.embedFonts = class_278.isEmbeddedFont(_loc3_.font);
      ...
      {
         var _loc2_:class_3367 = class_3388.getStyle(param1);
         if(!_loc2_)
         {
            return null;
         }
