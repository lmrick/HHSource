package com.sulake.air
{
   ...
   public class FileProxy implements IFileProxy
   {
      ...
      private static var var_4153:int = 0;
       
      
      private var var_2215:Dictionary;
      ...
      private static function resolveFileFromLocalPath(param1:String) : String
      {
         ...
         if(_loc2_ != -1)
         {
            return param1.substr(_loc2_ + 14);
         }
         return param1;
      }
      ...
      public function readCacheAsync(param1:String, param2:Function) : void
      {
         ...
         try
         {
            ...
            class_14.log("[FileProxy] Read file undefined");
      ...
      private function addCallback(param1:String, param2:Function) : void
      {
         if(!var_2215)
         {
            var_2215 = new Dictionary();
         }
         var _loc3_:* = var_2215[param1];
         if(!_loc3_)
         {
            _loc3_ = [];
            var_2215[param1] = _loc3_;
         }
         _loc3_.push(param2);
      }
