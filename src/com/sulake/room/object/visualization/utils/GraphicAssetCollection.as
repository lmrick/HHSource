package com.sulake.room.object.visualization.utils
{
   ...
   public class GraphicAssetCollection implements IGraphicAssetCollection
   {
      ...
      private var var_3318:Map;
      
      private var var_2107:int = 0;
      
      private var var_3429:int = 0;
      
      private var var_2013:Dictionary;
      
      public function GraphicAssetCollection()
      {
         super();
         _assets = new class_24();
         var_1723 = new class_24();
         var_3318 = new class_24();
         var_2019 = [];
         var_2013 = new Dictionary();
      }
      ...
      public function dispose() : void
      {
         ...
         if(var_1723 != null)
         {
            for(_loc2_ in var_1723)
            {
               _loc1_ = var_1723[_loc2_];
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
         ...
         if(var_2013)
         {
            for(var _loc4_ in var_2013)
            {
               delete var_2013[_loc4_];
            }
         }
         var_1822 = null;
      }
      ...
      private function defineAssets(param1:XMLList) : void
      {
         ...
         while(_loc3_ < _loc14_)
         {
            ...
            if((_loc10_ = _loc2_.@name).length > 0)
            {
               ...
               if((_loc13_ = var_1822.getAssetByName(_loc4_)) != null)
               {
      ...
      private function definePalettes(param1:XMLList) : void
      {
         ...
         {
            if(class_1667.checkRequiredAttributes(_loc5_,PALETTE_ATTRIBUTES))
            {
               _loc6_ = _loc5_.@id;
               _loc7_ = _loc5_.@source;
               if(true)
               {
                  if((_loc8_ = var_1822.getAssetByName(_loc7_)).content == null)
                  {
                  ...
                  else
                  {
                     ...
                     var_1723[_loc6_] = _loc4_;
                     var_3318[_loc6_] = _loc5_;
                  }
               }
            }
         }
      ...
      public function getAsset(param1:String) : IGraphicAsset
      {
         ...
         if(_loc5_ = var_2013[param1])
         {
            ...
            if((_loc11_ = var_1822.getAssetByName(_loc7_)) != null)
            {
      ...
      public function addAsset(param1:String, param2:BitmapData, param3:Boolean, param4:int = 0, param5:int = 0, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         {
            _loc8_ = new BitmapDataAsset(var_1822.getAssetTypeDeclarationByClass(BitmapDataAsset));
            var_1822.setAsset(param1,_loc8_);
      ...
      {
         return var_1822.getAssetByName(param1) as BitmapDataAsset;
      }
      ...
      private function addLibraryAsset(param1:String, param2:BitmapData) : BitmapDataAsset
      {
         ...
         if(_loc3_ == null)
         {
            _loc3_ = new BitmapDataAsset(var_1822.getAssetTypeDeclarationByClass(BitmapDataAsset));
            var_1822.setAsset(param1,_loc3_);
      ...
      private function disposePaletteAssets(param1:Boolean = true) : void
      {
         if(var_2019 != null)
         {
            if(param1 || false)
            {
               for each(var _loc2_ in var_2019)
               {
                  disposeAsset(_loc2_);
               }
               var_2019 = [];
