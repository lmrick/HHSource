package com.sulake.habbo.phonenumber
{
   ...
   public class VerificationCodeInputMinimizedView
   {
      ...
      public function VerificationCodeInputMinimizedView(param1:com.sulake.habbo.phonenumber.HabboPhoneNumber)
      {
         super();
         var_1460 = param1;
         createWindow();
      ...
      private function createWindow() : void
      {
         ...
         _window = var_1460.windowManager.buildFromXML(XML(var_1460.assets.getAssetByName("phonenumber_verify_minimized_xml").content));
      ...
      {
         var_1460.setVerifyViewMinimized(false);
      }
