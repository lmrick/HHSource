package com.sulake.habbo.utils
{
   ...
   public class FriendlyTime
   {
      ...
      private static const const_588:uint = 60;
      
      private static const const_779:uint = 3600;
      
      private static const const_644:uint = 86400;
      
      private static const const_1186:uint = 604800;
      ...
      public static function getFriendlyTime(param1:class_18, param2:Number, param3:String = "", param4:int = 3) : String
      {
      ...
      public static function getShortFriendlyTime(param1:class_18, param2:Number, param3:String = "", param4:int = 3) : String
      {
         if(param2 > param4 * 31536000)
         {
      ...
      public static function getLocalization(param1:class_18, param2:String, param3:int) : String
      {
