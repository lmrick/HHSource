package com.sulake.habbo.utils
{
   ...
   public class CommunicationUtils
   {
      ...
      public static const const_144:String = "facebook";
      
      private static const SOL_ID:String = "fuselogin";
      
      private static const SOL_PROPERTY_PASSWORD:String = "password";
      
      private static var var_711:Boolean;
      
      private static var var_157:com.sulake.habbo.utils.IEncryptedLocalStorage;
      ...
      public static function set encryptedLocalStorage(param1:com.sulake.habbo.utils.IEncryptedLocalStorage) : void
      {
         var_157 = param1;
      }
      ...
      public static function storePassword(param1:String) : void
      {
         if(var_157)
         {
            if(var_157.storeString("password",param1))
            {
               writeSOLProperty("password","");
            }
            else
      ...
      public static function restorePassword() : String
      {
         ...
         if(var_157)
         {
            _loc1_ = var_157.restoreString("password");
         }
         if(!_loc1_)
         {
      ...
      public static function decodeFromBitmap(param1:BitmapData) : String
      {
         ...
         while(_loc18_ < _loc10_)
         {
            ...
            {
               _loc5_ = ((_loc18_ + _loc13_) * _loc16_ + _loc17_) * 4;
               _loc6_ = _loc8_;
               while(_loc6_ < 4)
               {
