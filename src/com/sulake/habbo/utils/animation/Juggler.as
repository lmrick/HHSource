package com.sulake.habbo.utils.animation
{
   ...
   public class Juggler implements com.sulake.habbo.utils.animation.class_66
   {
      
      public static const REMOVE_FROM_JUGGLER:String = "REMOVE_FROM_JUGGLER";
       
      
      private var var_26:Vector.<com.sulake.habbo.utils.animation.class_66>;
      ...
      public function Juggler()
      {
         super();
         mElapsedTime = 0;
         var_26 = new Vector.<com.sulake.habbo.utils.animation.class_66>(0);
      }
      
      public function add(param1:com.sulake.habbo.utils.animation.class_66) : void
      {
         var _loc2_:EventDispatcher = null;
         if(param1 && var_26.indexOf(param1) == -1)
         {
            var_26[var_26.length] = param1;
      ...
      public function contains(param1:com.sulake.habbo.utils.animation.class_66) : Boolean
      {
         return var_26.indexOf(param1) != -1;
      }
      
      public function remove(param1:com.sulake.habbo.utils.animation.class_66) : void
      {
         if(param1 == null)
         {
            return;
         ...
         var _loc2_:int = var_26.indexOf(param1);
         if(_loc2_ != -1)
         {
            var_26[_loc2_] = null;
         }
      ...
      public function purge() : void
      {
         ...
         while(_loc1_ >= 0)
         {
            _loc2_ = var_26[_loc1_] as EventDispatcher;
            if(_loc2_)
            {
               _loc2_.removeEventListener("REMOVE_FROM_JUGGLER",onRemove);
            }
      ...
      public function delayCall(param1:Function, param2:Number, ... rest) : com.sulake.habbo.utils.animation.class_66
      {
         if(param1 == null)
         {
            return null;
      ...
      public function repeatCall(param1:Function, param2:Number, param3:int = 0, ... rest) : com.sulake.habbo.utils.animation.class_66
      {
         if(param1 == null)
         {
            return null;
      ...
      public function tween(param1:Object, param2:Number, param3:Object) : com.sulake.habbo.utils.animation.class_66
      {
      ...
      {
         var _loc2_:int = 0;
         var _loc5_:com.sulake.habbo.utils.animation.class_66 = null;
         var _loc4_:int = 0;
         var _loc3_:int = 0;
         mElapsedTime += param1;
         if(_loc4_ == 0)
         ...
         while(_loc2_ < _loc4_)
         {
            if(_loc5_ = var_26[_loc2_])
            {
               if(_loc3_ != _loc2_)
               {
                  var_26[_loc3_] = _loc5_;
                  var_26[_loc2_] = null;
               }
         ...
         if(_loc3_ != _loc2_)
         {
            ...
            while(_loc2_ < _loc4_)
            {
               var_26[_loc3_++] = var_26[_loc2_++];
            }
            var_26.length = _loc3_;
         }
      }
      
      private function onRemove(param1:Event) : void
      {
         remove(param1.target as com.sulake.habbo.utils.animation.class_66);
      ...
      protected function get objects() : Vector.<com.sulake.habbo.utils.animation.class_66>
      {
         return var_26;
      }
   }
