package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcherWrapper
   {
      ...
      private var var_1880:com.sulake.habbo.avatar.class_1691;
      
      private var _geometry:AvatarModelGeometry;
      
      private var var_2021:AvatarActionManager;
      
      private var var_117:FigureSetData;
      
      private var var_1933:PartSetsData;
      
      private var var_1578:AnimationData;
      
      private var var_2303:AnimationManager;
      
      private var _defaultAction:ActionDefinition;
      
      private var var_1926:Dictionary;
      
      public function AvatarStructure(param1:com.sulake.habbo.avatar.class_1691)
      {
         super();
         var_1880 = param1;
         var_117 = new FigureSetData();
         var_1933 = new PartSetsData();
         var_1578 = new AnimationData();
         var_2303 = new AnimationManager();
         var_1926 = new Dictionary();
      }
      ...
      public function initActions(param1:class_21, param2:XML) : void
      {
         if(!param2)
         {
            return;
         }
         var_2021 = new AvatarActionManager(param1,param2);
         _defaultAction = var_2021.getDefaultAction();
      }
      
      public function updateActions(param1:XML) : void
      {
         var_2021.updateActions(param1);
         _defaultAction = var_2021.getDefaultAction();
      }
      ...
      public function initPartSets(param1:XML) : Boolean
      {
         ...
         if(var_1933.parse(param1))
         {
            var_1933.getPartDefinition("ri").appendToFigure = true;
            var_1933.getPartDefinition("li").appendToFigure = true;
            return true;
         }
         return false;
      }
      ...
      public function initFigureData(param1:XML) : Boolean
      {
         ...
         return var_117.parse(param1);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         var_117.injectXML(param1);
      }
      ...
      public function registerAnimations(param1:AssetLibraryCollection, param2:String = "fx", param3:int = 200) : void
      {
         ...
         while(_loc5_ < param3)
         {
            if(param1.hasAsset(param2 + _loc5_))
            {
               ...
               var_2303.registerAnimation(this,_loc4_);
            }
            _loc5_++;
         }
      }
      ...
      {
         var_2303.registerAnimation(this,param1);
      }
      
      public function getPartColor(param1:class_3182, param2:String, param3:int = 0) : IPartColor
      {
         var _loc4_:Array;
         ...
         var _loc6_:ISetType;
         if((_loc6_ = var_117.getSetType(param2)) == null)
         {
            return null;
         }
         var _loc5_:class_3220;
         if(!(_loc5_ = var_117.getPalette(_loc6_.paletteID)))
         {
            return null;
         }
      ...
      {
         return var_2303.getLayerData(param1,param2,param3) as AnimationLayerData;
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_2303.getAnimation(param1) as Animation;
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_2021.getActionDefinition(param1);
      }
      
      public function getActionDefinitionWithState(param1:String) : ActionDefinition
      {
         return var_2021.getActionDefinitionWithState(param1);
      }
      ...
      {
         return var_2021.sortActions(param1);
      }
      ...
      public function maxFrames(param1:Array) : int
      {
         ...
         {
            _loc2_ = Math.max(_loc2_,var_1578.getFrameCount(_loc3_.definition));
         }
         return _loc2_;
      }
      ...
      public function getMandatorySetTypeIds(param1:String, param2:int) : Array
      {
         if(true)
         {
            var_1926[param1] = new Dictionary();
         }
         if(var_1926[param1][param2])
         {
            return var_1926[param1][param2];
         }
         var_1926[param1][param2] = var_117.getMandatorySetTypeIds(param1,param2);
         return var_1926[param1][param2];
      }
      
      public function getDefaultPartSet(param1:String, param2:String) : class_3195
      {
         return var_117.getDefaultPartSet(param1,param2);
      }
      
      public function getCanvasOffsets(param1:Array, param2:String, param3:int) : Array
      {
         return var_2021.getCanvasOffsets(param1,param2,param3);
      }
      ...
      public function removeDynamicItems(param1:class_3156) : void
      {
         _geometry.removeDynamicItems(param1);
      }
      
      public function getActiveBodyPartIds(param1:class_3311, param2:class_3156) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            if((_loc8_ = var_2303.getAnimation(_loc4_) as Animation) != null)
            {
               ...
               if(_loc8_.hasAddData())
               {
                  ...
                  for each(var _loc3_ in _loc8_.addData)
                  {
                     if((_loc7_ = _geometry.getBodyPart(_loc13_,_loc3_.align)) != null)
                     {
                        ...
                        (_loc14_ = var_1933.addPartDefinition(_loc9_)).appendToFigure = true;
                        if(_loc3_.base == "")
                        {
                           _loc14_.staticId = 1;
                        }
         ...
         {
            _loc11_ = var_1933.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = Number(AvatarDirectionAngle.const_441[param3]);
         return _geometry.getBodyPartsAtAngle(param1,_loc4_,param2);
      }
      
      public function getFrameBodyPartOffset(param1:class_3311, param2:int, param3:int, param4:String) : Point
      {
         var _loc5_:AnimationAction;
         if(_loc5_ = var_1578.getAction(param1.definition))
         {
      ...
      public function getParts(param1:String, param2:class_3182, param3:class_3311, param4:String, param5:int, param6:Array, param7:class_3156, param8:class_24 = null) : Vector.<AvatarImagePartContainer>
      {
         ...
         var _loc24_:class_3220 = null;
         var _loc17_:class_3195 = null;
         var _loc18_:* = null;
         ...
         var _loc9_:Array = var_1933.getActiveParts(param3.definition);
         var _loc46_:* = [];
         var _loc35_:* = [0];
         var _loc38_:AnimationAction = var_1578.getAction(param3.definition);
         if(param3.definition.isAnimation)
         {
            _loc27_ = param3.definition.state + "." + param3.actionParameter;
            if((_loc37_ = var_2303.getAnimation(_loc27_) as Animation) != null)
            {
         ...
         for each(_loc41_ in _loc33_)
         {
            ...
            if(_loc36_ = var_117.getSetType(_loc41_))
            {
               if(_loc24_ = var_117.getPalette(_loc36_.paletteID))
               {
                  if(_loc17_ = _loc36_.getPartSet(_loc48_))
                  {
                     ...
                     for each(_loc18_ in _loc17_.parts)
                     {
                        if(_loc20_.indexOf(_loc18_.type) > -1)
                        {
                           ...
                           if((_loc34_ = (_loc28_ = var_1933.getPartDefinition(_loc18_.type)) == null ? _loc18_.type : _loc28_.flippedSetType) == "")
                           {
         ...
         for each(_loc26_ in _loc20_)
         {
            ...
            if(!_loc19_)
            {
               ...
               else if(_loc9_.indexOf(_loc26_) > -1)
               {
                  ...
                  {
                     _loc28_ = var_1933.getPartDefinition(_loc26_);
                     _loc11_ = false;
                     _loc12_ = 1;
      ...
      public function get figureData() : class_3143
      {
         return var_117;
      }
      ...
      public function get renderManager() : com.sulake.habbo.avatar.class_1691
      {
         return var_1880;
      }
      ...
      public function getItemIds() : Array
      {
         ...
         if(var_2021)
         {
            _loc2_ = var_2021.getActionDefinition("CarryItem").params;
            _loc1_ = [];
