package com.sulake.habbo.avatar.enum
{
   public class AvatarAction
   {
      ...
      public static const const_977:String = "expression";
      
      public static const const_1035:String = "vote";
      
      public static const const_449:String = "dance";
      ...
      public static const const_976:String = "respect";
      ...
      public static const const_1180:String = "cry";
      
      public static const const_522:String = "idle";
      ...
      private static const const_425:Array = ["","wave","blow","laugh","cry","idle","dance","respect","sbollie","sb360","ridejump"];
      ...
      {
         return const_425.indexOf(param1);
      }
      
      public static function getExpression(param1:int) : String
      {
         if(param1 < const_425.length)
         {
            return const_425[param1];
         }
         return "";
      }
