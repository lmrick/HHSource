package com.sulake.habbo.avatar.geometry
{
   public class Vector3D
   {
      ...
      {
         return var_29 * param1.x + var_28 * param1.y + var_30 * param1.z;
      }
      ...
      public function cross(param1:Vector3D) : Vector3D
      {
         ...
         _loc2_.y = var_30 * param1.x - var_29 * param1.z;
         _loc2_.z = var_29 * param1.y - var_28 * param1.x;
         return _loc2_;
      }
      ...
      {
         return Math.sqrt(var_29 * var_29 + var_28 * var_28 + var_30 * var_30);
      }
      
      public function toString() : String
      {
         return "Vector3D: (" + var_29 + "," + var_28 + "," + var_30 + ")";
      }
