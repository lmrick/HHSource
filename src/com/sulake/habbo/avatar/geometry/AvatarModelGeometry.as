package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarModelGeometry
   {
      ...
      private var var_3569:com.sulake.habbo.avatar.geometry.AvatarSet;
      
      private var var_2423:Dictionary;
      
      private var var_3694:Dictionary;
      
      private var _transformation:com.sulake.habbo.avatar.geometry.Matrix4x4;
      
      private var _camera:com.sulake.habbo.avatar.geometry.Vector3D;
      ...
      public function AvatarModelGeometry(param1:XML)
      {
         ...
         _camera = new com.sulake.habbo.avatar.geometry.Vector3D(0,0,10);
         super();
         _transformation = new com.sulake.habbo.avatar.geometry.Matrix4x4();
         var_2423 = new Dictionary();
         var_3694 = new Dictionary();
         var_3569 = new com.sulake.habbo.avatar.geometry.AvatarSet(param1.avatarset[0]);
         var_1627 = new Dictionary();
         var _loc8_:XML;
         ...
         for each(_loc15_ in param1.type)
         {
            ...
            var_2423[String(_loc15_.@id)] = _loc7_;
            var_3694[String(_loc15_.@id)] = _loc5_;
         }
      }
      ...
      {
         var _loc3_:* = [];
         var _loc2_:com.sulake.habbo.avatar.geometry.AvatarSet = var_3569.findAvatarSet(param1);
         if(_loc2_ != null)
         {
      ...
      public function getCanvas(param1:String, param2:String) : AvatarCanvas
      {
         ...
         var _loc3_:Dictionary = var_1627[param1];
         if(_loc3_ != null)
         {
      ...
      private function hasBodyPart(param1:String, param2:String) : Boolean
      {
         ...
         {
            _loc3_ = var_2423[param1] as Dictionary;
      ...
      private function getBodyPartsOfType(param1:String) : Dictionary
      {
         if(typeExists(param1))
         {
            return var_2423[param1] as Dictionary;
         }
      ...
      public function getBodyPartOfItem(param1:String, param2:String, param3:class_3156) : GeometryBodyPart
      {
         var _loc6_:GeometryBodyPart = null;
         var _loc5_:Dictionary = null;
         var _loc4_:Dictionary;
         if((_loc4_ = var_3694[param1]) != null)
         {
      ...
      public function getBodyPartsAtAngle(param1:String, param2:uint, param3:String) : Array
      {
         ...
         var _loc9_:* = [];
         var _loc5_:* = [];
         _transformation = com.sulake.habbo.avatar.geometry.Matrix4x4.getYRotationMatrix(param2);
         for each(_loc10_ in _loc6_)
         {
            _loc10_.applyTransform(_transformation);
      ...
      public function getParts(param1:String, param2:String, param3:uint, param4:Array, param5:class_3156) : Array
      {
         var _loc6_:GeometryBodyPart = null;
         if(hasBodyPart(param1,param2))
         {
            _loc6_ = getBodyPartsOfType(param1)[param2] as GeometryBodyPart;
            _transformation = com.sulake.habbo.avatar.geometry.Matrix4x4.getYRotationMatrix(param3);
            return _loc6_.getParts(_transformation,_camera,param4,param5);
         }
         return [];
      }
