package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      public function dispose() : void
      {
         if(var_1668)
         {
            for each(var _loc2_ in var_1668)
            {
               _loc2_.dispose();
            }
            var_1668 = null;
         ...
         if(var_1723)
         {
            for each(var _loc3_ in var_1723 as Array)
            {
               if(_loc3_)
               {
      ...
      public function selectColorIds(param1:Array) : void
      {
         ...
         var_1686 = new Array(param1.length);
         _loc7_ = 0;
         while(_loc7_ < var_1723.length)
         {
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(var_2333 >= 0 && var_1668.length > var_2333)
         {
            _loc2_ = var_1668[var_2333];
            if(_loc2_)
            {
               _loc2_.isSelected = false;
            }
         }
         if(var_1668.length > param1)
         {
            _loc3_ = var_1668[param1] as AvatarEditorGridPartItem;
            if(_loc3_)
            {
      ...
      public function selectColorIndex(param1:int, param2:int) : AvatarEditorGridColorItem
      {
         ...
         deselectColorIndex(var_1686[param2],param2);
         var_1686[param2] = param1;
      ...
      public function getSelectedColorIds() : Array
      {
         ...
         var _loc4_:Array;
         if(!(_loc4_ = var_1723[0] as Array) || _loc4_.length == 0)
         {
            return null;
         }
         ...
         var _loc2_:* = [];
         _loc8_ = 0;
         while(_loc8_ < var_1686.length)
         {
            if(!(!(_loc7_ = var_1723[_loc8_]) || _loc7_.length <= _loc8_))
            {
               if(_loc7_.length > var_1686[_loc8_])
               {
                  if((_loc5_ = _loc7_[var_1686[_loc8_]] as AvatarEditorGridColorItem) && _loc5_.partColor)
                  {
      ...
      public function getSelectedColor(param1:int) : AvatarEditorGridColorItem
      {
         ...
         if(!_loc2_ || _loc2_.length <= var_1686[param1])
         {
            return null;
         }
         return _loc2_[var_1686[param1]] as AvatarEditorGridColorItem;
      }
      ...
      public function getPalette(param1:int) : Array
      {
         ...
         if(var_1723.length <= param1)
         {
            return null;
         }
         return var_1723[param1] as Array;
      }
      
      public function getCurrentPart() : AvatarEditorGridPartItem
      {
         return var_1668[var_2333] as AvatarEditorGridPartItem;
      }
      ...
      public function stripInvalidSellableItems(param1:class_1697) : Boolean
      {
         var _loc3_:class_3195 = null;
         var _loc2_:AvatarEditorGridPartItem = null;
         var _loc4_:AvatarEditorGridPartItem;
