package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_895:String = "_";
      ...
      private static var var_2636:Array;
       
      
      private var var_1469:AvatarStructure;
      
      private var var_224:class_3156;
      ...
      private var var_1492:AvatarCanvas;
      ...
      private var var_1476:Matrix;
      
      private var var_2647:Array;
      
      private var var_3420:Boolean = false;
      
      public function AvatarImageCache(param1:AvatarStructure, param2:class_3156, param3:AssetAliasCollection, param4:String, param5:Boolean)
      {
         var _loc6_:int = 0;
         var_2690 = [];
      ...
      public function resetBodyPartCache(param1:class_3311) : void
      {
         var _loc2_:* = null;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         var _loc3_:Array = var_1469.getBodyPartsUnordered(param1);
      ...
      public function setAction(param1:class_3311, param2:int) : void
      {
         var _loc4_:* = null;
         var _loc5_:AvatarImageBodyPartCache = null;
         var _loc3_:Array = var_1469.getActiveBodyPartIds(param1,var_224);
      ...
      public function setGeometryType(param1:String) : void
      {
         ...
         if(var_2165 == "sitting" && param1 == "vertical" || var_2165 == "vertical" && param1 == "sitting" || (var_2165 == "swhorizontal" || param1 == "swhorizontal"))
         {
            var_2165 = param1;
            var_1492 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int, param3:Boolean = false) : AvatarImageBodyPartContainer
      {
         ...
         var _loc8_:* = _loc15_;
         var _loc4_:* = [];
         var _loc16_:class_24 = new class_24();
         ...
         if(!(!_loc15_ || !_loc15_.definition))
         {
            ...
            {
               _loc7_ = _loc11_;
               _loc14_ = var_1469.getAnimation(_loc15_.definition.state + "." + _loc15_.actionParameter);
         ...
         {
            if(!(_loc20_ = var_1469.getParts(param1,var_224.getFigure(),_loc8_,var_2165,_loc11_,_loc4_,var_224,_loc16_)))
            {
               return null;
            }
         ...
         _loc6_.offset = _loc12_.add(var_1469.getFrameBodyPartOffset(_loc8_,_loc11_,_loc9_,param1));
         return _loc6_;
      }
      
      public function getServerRenderData() : Array
      {
         var _loc1_:Array = var_2647;
         var_2647 = [];
         return _loc1_;
      }
      ...
      private function renderBodyPart(param1:int, param2:Vector.<AvatarImagePartContainer>, param3:int, param4:class_3311, param5:Boolean = false) : AvatarImageBodyPartContainer
      {
         ...
         if(!var_1492)
         {
            var_1492 = var_1469.getCanvas(var_757,var_2165);
            if(!var_1492)
            {
               return null;
            }
         ...
         while(_loc24_ >= 0)
         {
            ...
            if(!(param1 == 7 && (_loc8_.partType == "fc" || _loc8_.partType == "ey")))
            {
               if(!(_loc8_.partType == "ri" && _loc8_.partId == null))
               {
                  ...
                  var_2397.length = 0;
                  _partNameArray[0] = var_3420 ? "h" : var_757;
                  _partNameArray[2] = _loc31_;
                  _partNameArray[4] = _loc18_;
                  _partNameArray[6] = _loc6_;
                  _partNameArray[8] = var_2636[_loc23_];
                  _partNameArray[10] = var_2636[_loc26_];
                  var_2397.appendStringArray(_partNameArray);
                  _loc10_ = var_2397.toString();
                  if((_loc30_ = _assets.getAssetByName(_loc10_) as BitmapDataAsset) == null)
                  {
                     var_2397.length = 0;
                     _partNameArray[2] = "std";
                     _partNameArray[10] = var_2636[0];
                     var_2397.appendStringArray(_partNameArray);
                     _loc10_ = var_2397.toString();
                  ...
                  if(_loc30_)
                  {
                     ...
                     else
                     {
                        ...
                        if(_loc8_.isColorable && _loc8_.color != null)
                        {
                           ...
                           var_1913.redMultiplier = _loc17_.redMultiplier;
                           var_1913.greenMultiplier = _loc17_.greenMultiplier;
                           var_1913.blueMultiplier = _loc17_.blueMultiplier;
                           var_1913.alphaMultiplier = _loc17_.alphaMultiplier;
                           _loc21_ = true;
                        }
                        else
                        {
                           var_1913.redMultiplier = var_1913.greenMultiplier = var_1913.blueMultiplier = var_1913.alphaMultiplier = 1;
                        }
                        if(_loc8_.isBlendable)
                        {
                           var_1913.concat(_loc8_.blendTransform);
                           _loc21_ = true;
                        }
                        _loc19_ = _loc30_.offset.clone();
                        if(_loc12_)
                        {
                           _loc19_.x += var_757 == "h" ? 65 : 31;
                        }
                        _loc11_ = null;
                        if(_loc21_)
                        {
                           (_loc11_ = new ColorTransform()).concat(var_1913);
                        }
                        if(param5)
                        {
                           ...
                           var_2647.push(_loc27_);
                        }
                        var_2690.push(new ImageData(_loc29_,_loc30_.rectangle,_loc19_,_loc12_,_loc11_));
                     }
                  }
               }
            }
         ...
         var _loc16_:ImageData = createUnionImage(var_2690,_loc25_);
         var _loc14_:int = var_757 == "h" ? -16 : -8;
         ...
         {
            _loc7_.x += var_757 == "h" ? 67 : 31;
         }
         _loc24_ = -1;
         while(_loc24_ >= 0)
         {
            if(_loc9_ = var_2690.pop())
            {
               _loc9_.dispose();
            }
            _loc24_--;
         ...
         if(var_3420)
         {
            _loc28_ = class_3310.resampleBitmapData(_loc28_,0.5);
         }
      ...
      private function createUnionImage(param1:Array, param2:Boolean) : ImageData
      {
         ...
         for each(_loc4_ in param1)
         {
            ...
            {
               var_1476.a = -1;
               var_1476.tx = _loc4_.rect.x + _loc4_.rect.width + _loc7_.x;
               var_1476.ty = _loc7_.y - _loc4_.rect.y;
               _loc3_.x = _loc7_.x;
               _loc3_.y = _loc7_.y;
               _loc3_.width = _loc4_.rect.width;
               _loc3_.height = _loc4_.rect.height;
               _loc6_.draw(_loc4_.bitmap,var_1476,_loc4_.colorTransform,null,_loc3_);
            }
            else if(_loc4_.colorTransform)
            {
               var_1476.a = 1;
               var_1476.tx = _loc7_.x - _loc4_.rect.x;
               var_1476.ty = _loc7_.y - _loc4_.rect.y;
               _loc3_.x = _loc7_.x;
               _loc3_.y = _loc7_.y;
               _loc3_.width = _loc4_.rect.width;
