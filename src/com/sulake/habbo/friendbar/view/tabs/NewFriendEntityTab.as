package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class NewFriendEntityTab extends Tab
   {
      ...
      private static const const_770:String = "new_friend_entity_xml";
      ...
      private static const const_421:Vector.<com.sulake.habbo.friendbar.view.tabs.NewFriendEntityTab> = new Vector.<com.sulake.habbo.friendbar.view.tabs.NewFriendEntityTab>();
      ...
      public static function allocate(param1:class_3394) : com.sulake.habbo.friendbar.view.tabs.NewFriendEntityTab
      {
         var _loc2_:com.sulake.habbo.friendbar.view.tabs.NewFriendEntityTab = const_421.length > 0 ? const_421.pop() : new com.sulake.habbo.friendbar.view.tabs.NewFriendEntityTab();
      ...
      override public function select(param1:Boolean) : void
      {
         ...
         if(!selected)
         {
            ...
            if(false)
            {
               (_loc6_ = WINDOWING.buildFromXML(ASSETS.getAssetByName("new_controls_piece_xml").content as XML) as class_3151).name = "controls";
      ...
      {
         var _loc1_:class_3151 = const_418.length > 0 ? const_418.pop() : WINDOWING.buildFromXML(ASSETS.getAssetByName("new_friend_entity_xml").content as XML) as class_3151;
