package com.sulake.habbo.notifications.singular
{
   ...
   public class HabboAlertDialogManager
   {
      ...
      public function HabboAlertDialogManager(param1:class_1684, param2:class_18, param3:IHabboHelp)
      {
         super();
      ...
      public function handleHotelClosedMessage(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         if(userThrownOutAtClose)
         {
            ...
            _windowManager.alert("${opening.hours.title}","${opening.hours.disconnected}",0,function(param1:class_3132, param2:class_3134):void
            {
               param1.dispose();
            });
         }
         else
         {
            ...
            _windowManager.alert("${opening.hours.title}","${opening.hours.closed}",0,function(param1:class_3132, param2:class_3134):void
            {
               param1.dispose();
            });
         }
