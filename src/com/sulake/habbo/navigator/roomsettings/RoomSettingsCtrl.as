package com.sulake.habbo.navigator.roomsettings
{
   ...
   import package_31.class_1028;
   import package_31.class_1365;
   import package_31.class_435;
   import package_31.class_814;
   import package_31.class_827;
   import package_31.class_946;
   import package_62.class_770;
   import package_62.class_938;
   ...
   public class RoomSettingsCtrl implements class_13, ILinkEventTracker
   {
      ...
      private var _originalData:class_1553;
      ...
      private var _usersWithRightsListCtrl:com.sulake.habbo.navigator.roomsettings.UserListCtrl;
      
      private var _friendsListCtrl:com.sulake.habbo.navigator.roomsettings.UserListCtrl;
      
      private var _confirmDialog:com.sulake.habbo.navigator.roomsettings.ConfirmDialogView;
      ...
      private var _allowPetsCheckBox:class_3176;
      
      private var _allowFoodConsumeCheckBox:class_3176;
      
      private var _allowWalkThroughCheckBox:class_3176;
      
      private var _allowDynCatsCheckBox:class_3176;
      
      private var _hideWallsCheckBox:class_3176;
      
      private var _hideWallsText:ITextWindow;
      
      private var _wallThicknessDropMenu:class_3287;
      
      private var _floorThicknessDropMenu:class_3287;
      
      private var _tabContext:ITabContextWindow;
      
      private var _chatModeDropMenu:class_3287;
      
      private var _chatBubbleWidthDropMenu:class_3287;
      
      private var _chatScrollSpeedDropMenu:class_3287;
      
      private var _floodFilterDropMenu:class_3287;
      ...
      private var _bannedUsersListCtrl:com.sulake.habbo.navigator.roomsettings.BanListCtrl;
      ...
      public function RoomSettingsCtrl(param1:class_1686)
      {
         super();
         _navigator = param1;
         _usersWithRightsListCtrl = new com.sulake.habbo.navigator.roomsettings.UserListCtrl(_navigator,false);
         _friendsListCtrl = new com.sulake.habbo.navigator.roomsettings.UserListCtrl(_navigator,true);
         _bannedUsersListCtrl = new com.sulake.habbo.navigator.roomsettings.BanListCtrl(_navigator);
      }
      ...
      public function startRoomSettingsEdit(param1:int) : void
      {
         ...
         _navigator.send(new class_1028(_flatId));
      ...
      public function onRoomSettings(param1:class_1553) : void
      {
      ...
      public function onFlatControllerAdded(param1:int, param2:class_1624) : void
      {
         if(isAcceptFlatControllerUpdate(param1))
         {
      ...
      {
         if(_window != null && false && isContentVisible(3))
         {
            refresh();
         }
      }
      ...
      {
         if(_window != null && false && isContentVisible(5))
         {
            refresh();
         }
      }
      ...
      private function prepareWindow() : void
      {
         ...
         if(_window == null)
         {
            _window = class_3281(_navigator.getXmlWindow("ros_room_settings"));
         }
         ...
         _allowPetsCheckBox = class_3176(_window.findChildByName("allow_pets_checkbox"));
         _allowFoodConsumeCheckBox = class_3176(_window.findChildByName("allow_foodconsume_checkbox"));
         _allowWalkThroughCheckBox = class_3176(_window.findChildByName("allow_walk_through_checkbox"));
         _allowWalkThroughCheckBox.addEventListener("WME_OVER",onWalkThroughMouseOver);
         _allowDynCatsCheckBox = class_3176(_window.findChildByName("allow_dyncats_checkbox"));
         _allowDynCatsCheckBox.visible = true;
         _window.findChildByName("allow_dyncats_text").visible = true;
         _hideWallsCheckBox = class_3176(_window.findChildByName("hide_walls_checkbox"));
         _hideWallsText = _window.findChildByName("hide_walls_text") as ITextWindow;
         _wallThicknessDropMenu = class_3287(_window.findChildByName("wall_thickness"));
         _floorThicknessDropMenu = class_3287(_window.findChildByName("floor_thickness"));
         _tabContext = ITabContextWindow(_window.findChildByName("tab_context"));
         _chatModeDropMenu = class_3287(_window.findChildByName("chat_mode"));
         _chatBubbleWidthDropMenu = class_3287(_window.findChildByName("chat_bubbles_width"));
         _chatBubbleWidthDropMenu.addEventListener("WME_OVER",onBubbleWidthMouseOver);
         _chatScrollSpeedDropMenu = class_3287(_window.findChildByName("chat_scroll_speed"));
         _chatScrollSpeedDropMenu.addEventListener("WME_OVER",onChatScrollSpeedMouseOver);
         _floodFilterDropMenu = class_3287(_window.findChildByName("chat_flood_sensitivity"));
      ...
      private function getPasswordContainer() : class_3151
      {
         return class_3151(_window.findChildByName("password_container"));
      }
      
      private function getRemoveAllFlatCtrlsButton() : class_3140
      {
         return class_3140(_window.findChildByName("remove_all_flat_ctrls"));
      }
      
      private function getRemoveFlatCtrlsButton() : class_3140
      {
         return class_3140(_window.findChildByName("remove_flat_ctrl"));
      }
      ...
      public function refresh() : void
      {
         ...
         if(!_useUnifiedWindow)
         {
            Util.hideChildren(class_3151(_window.findChildByName("content_container")));
      ...
      private function getTabContainer(param1:int) : class_3151
      {
         return class_3151(_window.findChildByName("tab_container_" + param1));
      }
      
      private function disableWindow(param1:class_3127) : void
      {
         if(param1 != null)
         {
            param1.disable();
      ...
      private function enableWindow(param1:class_3127) : void
      {
         if(param1 != null)
         {
            param1.enable();
      ...
      private function populateForm() : void
      {
         ...
         _populating = true;
         var _loc2_:class_1553 = _originalData;
         ...
         {
            _window.findChildByName("doormode_override_info").visible = false && !_navigator.sessionData.hasSecurity(4);
      ...
      private function populateRoomModerationSettings(param1:class_1553) : void
      {
         var _loc4_:* = _groupId > 0;
         roomModerationMuteSettings = _groupId > 0 ? [0,1,4,5] : [0,1];
         roomModerationBanSettings = _loc4_ ? [0,1,4,5] : [0,1];
         roomModerationKickSettings = _loc4_ ? [0,1,2,4,5] : [0,1,2];
         var _loc2_:class_3287 = class_3287(_window.findChildByName("moderation_mute_dropdown"));
         ...
         var _loc3_:class_3287 = class_3287(_window.findChildByName("moderation_ban_dropdown"));
         ...
         var _loc6_:class_3287;
         (_loc6_ = class_3287(_window.findChildByName("moderation_kick_dropdown"))).populate(localizeItems(roomModerationKickSettings));
      ...
      private function refreshMaxVisitors(param1:class_1553) : void
      {
         var _loc3_:int = 0;
         var _loc5_:* = [];
         var _loc6_:* = -1;
         ...
         var _loc7_:class_3287;
         (_loc7_ = _window.findChildByName("maxvisitors") as class_3287).populate(_loc5_);
         _loc7_.selection = _loc6_ > -1 ? _loc6_ : 0;
      }
      
      private function setCategorySelection(param1:int) : void
      {
         var _loc2_:class_3287 = _window.findChildByName("categories") as class_3287;
         var _loc4_:* = [];
         var _loc6_:* = 0;
         var _loc3_:int = 0;
      ...
      {
         var _loc2_:class_3287 = _window.findChildByName("tradesettings") as class_3287;
         var _loc3_:* = [];
      ...
      private function getFlatCategoryByIndex(param1:int, param2:int) : class_1625
      {
         var _loc3_:int = 0;
      ...
      private function save() : void
      {
         ...
         if(_originalData == null || _window == null || false)
         {
            return;
         }
         var _loc3_:class_1365 = new class_1365();
         ...
         var _loc7_:class_3287 = _window.findChildByName("categories") as class_3287;
         var _loc8_:class_1625 = getFlatCategoryByIndex(_originalData.categoryId,_loc7_.selection);
         _loc3_.categoryId = _loc8_.nodeId;
         var _loc1_:class_3287 = _window.findChildByName("tradesettings") as class_3287;
         _loc3_.tradeMode = _loc1_.selection;
         var _loc9_:class_3287 = _window.findChildByName("maxvisitors") as class_3287;
         ...
         _loc3_.wallThickness = -2;
         _loc3_.floorThickness = -2;
         _loc3_.tags = [];
         ...
         _navigator.send(new class_435(_loc3_));
      }
      ...
      private function setModeratorSettings(param1:class_1365) : void
      {
         var _loc2_:class_3287 = class_3287(_window.findChildByName("moderation_mute_dropdown"));
         param1.whoCanMute = roomModerationMuteSettings[_loc2_.selection];
         var _loc3_:class_3287 = class_3287(_window.findChildByName("moderation_ban_dropdown"));
         param1.whoCanBan = roomModerationBanSettings[_loc3_.selection];
         var _loc4_:class_3287 = class_3287(_window.findChildByName("moderation_kick_dropdown"));
         param1.whoCanKick = roomModerationKickSettings[_loc4_.selection];
      }
      
      private function onDeleteButtonClick(param1:class_3134, param2:class_3127) : void
      {
         ...
         _confirmDialog = new com.sulake.habbo.navigator.roomsettings.ConfirmDialogView(_navigator,onConfirmRoomDelete,"${navigator.roomsettings}","${navigator.roomsettings.deleteroom.confirm.message}");
      }
      
      private function onBuildersClubFaqButtonClick(param1:class_3134, param2:class_3127) : void
      {
         if(param1.type != "WME_CLICK")
         {
            return;
         ...
         if(false)
         {
            (_navigator.windowManager as class_20).context.createLinkEvent("habbopages/builders-club/faq");
         }
      }
      ...
      {
         var _loc1_:class_1630 = null;
         _navigator.send(new class_814(_originalData.roomId));
         close();
      ...
      private function onDoorModePasswordSelect(param1:class_3134) : void
      {
         changePasswordField(true);
      }
      
      private function onDoorModePasswordUnselect(param1:class_3134) : void
      {
      ...
      private function refreshFlatControllers() : void
      {
         ...
         if(true)
         {
            ...
            _navigator.send(new class_827(_originalData.roomId));
            _loc2_ = [];
         }
         else
         {
         ...
         _navigator.registerParameter("navigator.flatctrls.userswithrights","displayed","undefined");
         _navigator.registerParameter("navigator.flatctrls.friends","displayed","undefined");
      ...
      private function refreshBannedUsers() : void
      {
         ...
         if(true)
         {
            _navigator.send(new class_946(_originalData.roomId));
            _loc1_ = [];
         }
         else
         {
      ...
      private function onRemoveAllFlatCtrlsClick(param1:class_3134) : void
      {
         ...
         _confirmDialog = new com.sulake.habbo.navigator.roomsettings.ConfirmDialogView(_navigator,onRemoveAllFlatCtrlsConfirm,"${navigator.flatctrls.removeconfirm.title}","${navigator.flatctrls.removeconfirm.info}");
      }
      
      private function onRemoveAllFlatCtrlsConfirm() : void
      {
         _navigator.send(new class_770(this._flatId));
      }
      ...
      private function onUserFilterChange(param1:class_3134) : void
      {
         refreshFlatControllers();
      }
      ...
      private function onUnbanClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:class_3127 = class_3151(_loc3_.getListItemAt(_bannedUsersListCtrl.selectedRow)).findChildByName("user_info_region");
         var _loc4_:int = _loc2_.id;
         _navigator.send(new class_938(_loc4_,_flatId));
      }
