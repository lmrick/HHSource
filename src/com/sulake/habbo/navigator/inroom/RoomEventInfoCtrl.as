package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventInfoCtrl implements class_13
   {
      ...
      public function RoomEventInfoCtrl(param1:class_1686)
      {
         super();
         _navigator = param1;
      }
      ...
      {
         if(true || _navigator.toolbar.extensionView == null || !enabled)
         {
            return;
         }
         ...
         _window.x = 0;
         _window.y = 0;
         _window.height = _expanded && _loc5_ ? _window.findChildByName("event_bg_visitor").height : _window.findChildByName("event_bg_contracted").height;
      }
      
      private function canExtend() : Boolean
      {
         var _loc2_:class_1573 = _navigator.data.roomEventData;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      private function prepareWindow() : void
      {
         ...
         _window = class_3151(_navigator.getXmlWindow("iro_event_info"));
      ...
      private function onModify(param1:class_3134, param2:class_3127) : void
      {
      ...
      private function onExtend(param1:class_3134, param2:class_3127) : void
      {
         var _loc3_:class_1573 = null;
         if(param1.type == "WME_CLICK")
         {
