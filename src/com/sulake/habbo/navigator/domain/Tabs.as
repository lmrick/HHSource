package com.sulake.habbo.navigator.domain
{
   ...
   public class Tabs
   {
      ...
      public static const const_660:int = 12;
      ...
      public static const const_974:int = 16;
      
      public static const const_611:int = 17;
      
      public static const const_919:int = 18;
      ...
      public static const const_896:int = 23;
      ...
      public function Tabs(param1:HabboNavigator)
      {
         ...
         _navigator = param1;
         var_1995 = [];
         var_1995.push(new Tab(_navigator,1,16,new EventsTabPageDecorator(_navigator),1));
         var_1995.push(new Tab(_navigator,6,21,new CategoriesTabPageDecorator(_navigator),5));
         var_1995.push(new Tab(_navigator,2,1,new RoomsTabPageDecorator(_navigator),1));
         var_1995.push(new Tab(_navigator,4,11,new OfficialTabPageDecorator(_navigator),4));
         var_1995.push(new Tab(_navigator,3,5,new MyRoomsTabPageDecorator(_navigator),1));
         var_1995.push(new Tab(_navigator,5,8,new SearchTabPageDecorator(_navigator),2));
         setSelectedTab(1);
      }
