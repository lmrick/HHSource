package com.sulake.habbo.navigator.mainview
{
   ...
   public class OfficialRoomEntryManager implements class_13
   {
      ...
      public function OfficialRoomEntryManager(param1:class_1686)
      {
         super();
         _navigator = param1;
      ...
      public function refreshAdFooter(param1:class_3151) : void
      {
         if(_navigator.data.adRoom == null)
         {
            return;
         }
         var _loc5_:class_3151 = class_3151(param1.getChildByName("ad_footer"));
         var _loc2_:class_3151 = class_3151(_loc5_.getChildByName("ad_cont"));
         if(_loc2_.numChildren < 1)
         {
            _loc2_.addChild(createEntry(true));
         }
         var _loc3_:class_3151 = class_3151(_loc2_.getChildAt(0));
         refreshEntry(_loc3_,true,_navigator.data.adRoom);
         _loc5_.visible = true;
         _navigator.data.adIndex++;
      }
      
      public function createEntry(param1:Boolean) : class_3151
      {
         var _loc3_:class_3282 = null;
         var _loc4_:class_3151 = class_3151(_navigator.getXmlWindow("grs_official_room_row_phase_one"));
         var _loc5_:class_3151 = class_3151(_loc4_.findChildByName("image_cont"));
         ...
         _loc3_ = _loc5_.findChildByName("rico_rnd_m") as class_3282;
         _loc3_.bitmap = _navigator.getButtonImage("rico_rnd_m");
         _loc3_.disposesBitmap = false;
         var _loc6_:class_3151 = class_3151(_loc4_.findChildByName("folder_cont"));
         ...
         _loc3_ = _loc6_.findChildByName("rico_rnd_m") as class_3282;
         _loc3_.bitmap = _navigator.getButtonImage("rico_rnd_m");
         _loc3_.disposesBitmap = false;
      ...
      public function refreshEntry(param1:class_3151, param2:Boolean, param3:class_1549) : void
      {
      ...
      private function refreshNormalEntry(param1:class_3151, param2:class_1549) : void
      {
      ...
      private function refreshFolderEntry(param1:class_3151, param2:class_1549) : void
      {
         var _loc3_:class_3151 = class_3151(param1.findChildByName("folder_cont"));
         _loc3_.visible = true;
         ...
         param1.height = 68;
         var _loc4_:class_3151 = class_3151(param1.findChildByName("folderNameContainer"));
         if(_loc5_.text == "")
         {
      ...
      private function refreshUserCount(param1:class_3151, param2:class_1549) : void
      {
         var _loc4_:int = 0;
         var _loc3_:int = 0;
         var _loc5_:int = 0;
         if(param2.showDetails && param2.type == 2)
         {
            ...
            _loc3_ = 34;
            _loc5_ = 13;
            var_2577.refreshUserCount(param2.maxUsers,param1,param2.userCount,"${navigator.usercounttooltip.users}",param1.width - _loc4_ - _loc3_,param1.height - _loc4_ - _loc5_);
         }
      }
      
      private function refreshCell(param1:class_3151, param2:class_1549) : void
      {
         var _loc3_:class_3151 = class_3151(param1.findChildByName("image_cont"));
         _loc3_.visible = true;
      ...
      private function refreshPicText(param1:class_3151, param2:class_1549) : void
      {
         var _loc6_:class_3151 = class_3151(param1.findChildByName("picTextContainer"));
      ...
      private function refreshFolderImage(param1:class_3151, param2:class_1549) : void
      {
         var _loc3_:class_3282 = class_3282(param1.findChildByName("folder_image"));
      ...
      private function refreshRoomImage(param1:class_3151, param2:class_1549) : void
      {
         var _loc3_:class_3282 = class_3282(param1.findChildByName("room_image"));
         _loc3_.visible = false;
         if(param2.picRef != "")
         {
            refreshCustomImage(param2,_loc3_);
      ...
      private function refreshCustomImage(param1:class_1549, param2:class_3282) : void
      {
      ...
      private function refreshGuestRoomImage(param1:class_3151, param2:class_1549, param3:class_3282) : void
      {
      ...
      private function refreshEmptyImage(param1:class_3151, param2:class_1549, param3:class_3282) : void
      {
      ...
      private function onCellMouseOver(param1:class_3134) : void
      {
         var _loc2_:class_3127 = param1.target;
         this.setEnterArrowVisibility(_loc2_,true);
      }
      
      private function onCellMouseOut(param1:class_3134) : void
      {
         var _loc2_:class_3127 = param1.target;
         this.setEnterArrowVisibility(_loc2_,false);
      }
      
      private function onCellMouseClick(param1:class_3134) : void
      {
         var _loc2_:class_3127 = param1.target;
         this.handleClick(_loc2_);
      }
      
      private function setEnterArrowVisibility(param1:class_3127, param2:Boolean) : void
      {
         var _loc4_:class_3282 = null;
         var _loc5_:class_3151;
         if((_loc5_ = class_3151(param1)) == null)
         {
            return;
         }
         var _loc3_:class_3151 = class_3151(_loc5_.findChildByName("enter_room"));
         if(_loc3_ == null)
         {
            return;
         }
         if(param2)
         {
            ...
            if((_loc4_ = class_3282(_loc3_.findChildByName("enter_room_m"))).bitmap == null)
            {
      ...
      private function handleClick(param1:class_3127) : void
      {
         var _loc2_:class_1549 = this.getEntry(param1);
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function getEntry(param1:class_3127) : class_1549
      {
         var _loc2_:class_3151 = param1 as class_3151;
      ...
      private function findAdEntry() : class_1549
      {
         return _navigator.data.adRoom;
      }
      
      private function findEntryInOfficialRoomList(param1:class_3151) : class_1549
      {
      ...
      private function refreshDetails(param1:class_3151, param2:class_1549) : void
      {
         var _loc3_:class_3151 = class_3151(param1.findChildByName("details_container"));
      ...
      private function refreshEntryCaption(param1:class_3151, param2:class_1549) : void
      {
      ...
      private function refreshEntryDesc(param1:class_3151, param2:class_1549) : void
      {
         var _loc4_:String;
         ...
         var _loc5_:ITextWindow;
         (_loc5_ = ITextWindow(param1.getChildByName("entry_desc"))).text = _loc4_;
         _loc5_.visible = true;
      }
      
      public function getPopupCaption(param1:class_1549) : String
      {
      ...
      public function getPopupDesc(param1:class_1549) : String
      {
         if(param1.popupCaption != null && param1.popupCaption != "")
         {
