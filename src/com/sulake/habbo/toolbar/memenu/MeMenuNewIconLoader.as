package com.sulake.habbo.toolbar.memenu
{
   ...
   public class MeMenuNewIconLoader implements class_1870
   {
      ...
      private var var_2633:class_195;
      ...
      public function MeMenuNewIconLoader(param1:HabboToolbar)
      {
         ...
         var_2633 = new class_195(onFigureUpdate);
         _toolbar.communicationManager.addHabboConnectionMessageEvent(var_2684);
         _toolbar.communicationManager.addHabboConnectionMessageEvent(var_2633);
      ...
      private function onFigureUpdate(param1:class_195) : void
      {
         if(disposed)
         {
            return;
      ...
      public function dispose() : void
      {
         ...
         if(var_2633 != null)
         {
            _toolbar.communicationManager.removeHabboConnectionMessageEvent(var_2633);
            var_2633 = null;
         }
         _toolbar = null;
      }
