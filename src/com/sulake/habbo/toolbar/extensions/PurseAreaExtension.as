package com.sulake.habbo.toolbar.extensions
{
   ...
   public class PurseAreaExtension implements class_13
   {
      ...
      public function PurseAreaExtension(param1:HabboToolbar, param2:IHabboCatalog)
      {
         super();
         _toolbar = param1;
         _window = _toolbar.windowManager.buildFromXML(param1.assets.getAssetByName("purse_xml").content as XML) as class_3151;
         _window.procedure = windowProcedure;
         _clubArea = new PurseClubArea(param1,_window as class_3151);
         _catalog = param2;
         ...
         var _loc3_:class_3127 = _window.findChildByName("credit_count");
      ...
      private function updateCreditAndPointValues() : void
      {
         ...
         var _loc1_:class_3127 = _window.findChildByName("credit_count");
         if(_loc1_ != null)
         {
      ...
      public function onCreditsBalance(param1:PurseEvent) : void
      {
         ...
         var _loc2_:class_3127 = _window.findChildByName("credit_count");
         if(_loc2_ != null)
         {
      ...
      public function getIconLocation(param1:String) : Rectangle
      {
         ...
         if(_loc3_)
         {
            ...
            _loc2_.x += _window.desktop.width - 0;
            _loc2_.y += _window.y;
         }
         return _loc2_;
      }
