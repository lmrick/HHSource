package com.sulake.habbo.toolbar.extensions.settings
{
   ...
   public class SoundSettingsItem implements class_13
   {
      ...
      private var var_2627:MeMenuSoundSettingsSlider;
      
      private var var_1776:com.sulake.habbo.toolbar.extensions.settings.SoundSettingsView;
      
      public function SoundSettingsItem(param1:com.sulake.habbo.toolbar.extensions.settings.SoundSettingsView, param2:int, param3:class_3151)
      {
         ...
         var_1776 = param1;
         _window = param3;
         var_2627 = new MeMenuSoundSettingsSlider(this,_window.findChildByName("volume_container") as class_3151,param1.toolbar.assets,0,1);
