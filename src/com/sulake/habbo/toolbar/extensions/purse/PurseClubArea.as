package com.sulake.habbo.toolbar.extensions.purse
{
   ...
   public class PurseClubArea extends CurrencyIndicatorBase
   {
      ...
      private var var_4264:int;
      
      public function PurseClubArea(param1:HabboToolbar, param2:class_3151)
      {
      ...
      public function onClubChanged(param1:HabboInventoryHabboClubEvent = null) : void
      {
         ...
         if(var_3478 != -1 && _toolbar.inventory.clubLevel != 0)
         {
            setAmount(_loc4_,_loc2_);
            _loc3_ = _window.findChildByName("hc_join_button") as class_3151;
            if(class_3353.getMotionByTarget(_loc3_) == null)
            {
               class_3353.runMotion(new DropBounce(_loc3_,900,16));
            }
         }
         var_3478 = _loc4_;
         var_4264 = _loc2_;
