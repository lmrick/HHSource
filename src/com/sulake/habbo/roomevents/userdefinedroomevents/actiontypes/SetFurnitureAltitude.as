package com.sulake.habbo.roomevents.userdefinedroomevents.actiontypes
{
   ...
   public class SetFurnitureAltitude extends DefaultActionType
   {
      ...
      public function SetFurnitureAltitude()
      {
         super();
      }
      ...
      {
         return class_3520.SET_FURNI_ALTITUDE;
      }
      ...
      override public function onEditStart(param1:class_3151, param2:class_1554) : void
      {
         ...
         getOperatorSelector().setSelected(getOperatorRadio(_loc4_));
      }
      ...
      override public function readIntParamsFromForm(param1:class_3151) : Array
      {
         ...
         _loc2_.push(getOperatorSelector().getSelected().id);
         return _loc2_;
      }
      
      private function getOperatorRadio(param1:int) : IRadioButtonWindow
      {
         return IRadioButtonWindow(_cont.findChildByName("op_" + param1 + "_radio"));
      }
      
      private function getOperatorSelector() : ISelectorWindow
      {
         return ISelectorWindow(_cont.findChildByName("op_selector"));
      }
