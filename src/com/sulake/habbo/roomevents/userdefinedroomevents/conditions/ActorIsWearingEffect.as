package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
   ...
   public class class_3428 extends DefaultConditionType
   {
       
      
      public function class_3428()
      {
         super();
      }
      ...
      {
         return class_3523.ACTOR_IS_WEARING_EFFECT;
      }
      
      override public function get negativeCode() : int
      {
         return class_3523.NOT_ACTOR_IS_WEARING_EFFECT;
      }
      
      override public function readIntParamsFromForm(param1:class_3151) : Array
      {
         var _loc2_:* = [];
         _loc2_.push(int(getInput(param1).text));
         return _loc2_;
      }
      
      override public function onEditStart(param1:class_3151, param2:class_1554) : void
      {
         getInput(param1).text = param2.intParams[0];
      }
