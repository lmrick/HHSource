package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
   ...
   public class class_3481 extends DefaultConditionType
   {
       
      
      public function class_3481()
      {
         super();
      }
      ...
      {
         return class_3523.STATES_MATCH;
      }
      
      override public function get negativeCode() : int
      {
         return class_3523.NOT_STATES_MATCH;
      }
      ...
      private function select(param1:class_3176, param2:Boolean) : void
      {
         if(param2)
         {
            param1.select();
