package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
   ...
   public class class_3484 extends DefaultConditionType
   {
      ...
      {
         return class_3523.TIME_ELAPSED_LESS;
      }
      ...
      private function onSliderChange(param1:Event) : void
      {
         ...
         if(param1.type == "change")
         {
            ...
            if(_loc2_)
            {
               ...
               _roomEvents.localization.registerParameter("wiredfurni.params.allowbefore","seconds",_loc3_);
            }
         }
      }
   }
