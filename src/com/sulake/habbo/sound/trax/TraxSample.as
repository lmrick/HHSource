package com.sulake.habbo.sound.trax
{
   ...
   public class TraxSample implements class_13
   {
      ...
      public function TraxSample(param1:ByteArray, param2:int, param3:String = "sample_44khz", param4:String = "sample_16bit")
      {
         ...
         var _loc15_:int = var_1614 * var_1515;
         ...
         param1.position = 0;
         var _loc9_:int = 0;
         var _loc7_:int = _loc14_ / var_1515;
         _loc8_ = 0;
         while(_loc8_ < _loc7_)
         {
            ...
            if(_loc8_ % var_1614 == var_1614 - 1)
            {
               _sampleData[int(_loc8_ / var_1614)] = _loc9_;
               _loc9_ = 0;
            }
            _loc8_++;
         }
      ...
      {
         return 0 * var_1614 * var_1515;
      }
      
      public function get usageCount() : int
      {
         return var_2242.length;
      }
      ...
      public function setSample(param1:Vector.<int>, param2:int, param3:int, param4:int) : int
      {
         ...
         var _loc5_:int = var_1614 * var_1515;
         param4 /= _loc5_;
         if(param2 < 0)
         {
            param3 += param2;
         ...
         else if(var_1515 >= 2)
         {
            ...
            if(var_1614 == 2)
            {
               while(_loc8_-- > 0)
               {
                  _loc6_ = ((_loc10_ = 0) >> 16 & 65535) - 32767;
                  _loc9_ = var_1515;
                  while(_loc9_ > 0)
                  {
      ...
      public function addSample(param1:Vector.<int>, param2:int, param3:int, param4:int) : int
      {
         ...
         var _loc7_:int;
         if((_loc7_ = param3 / _loc5_) > 0 - param4)
         {
            _loc7_ = 0 - param4;
         }
         if(var_1515 == 1)
         ...
         else if(var_1515 >= 2)
         {
            ...
            if(var_1614 == 2)
            {
               while(_loc7_-- > 0)
               {
                  _loc6_ = ((_loc9_ = 0) >> 16 & 65535) - 32767;
                  _loc8_ = var_1515;
                  while(_loc8_ > 0)
                  {
                     var _loc10_:* = param2++;
      ...
      public function setUsageFromSong(param1:int, param2:uint) : void
      {
         ...
         if(var_2242.indexOf(param1) == -1)
         {
            var_2242.push(param1);
         }
         var_4050 = param2;
      }
      ...
      public function isUsedFromSong(param1:int) : Boolean
      {
         ...
         return var_2242.indexOf(param1) != -1;
      }
   }
}
