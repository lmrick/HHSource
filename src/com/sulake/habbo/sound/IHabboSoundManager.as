package com.sulake.habbo.sound
{
   ...
   public interface IHabboSoundManager extends IUnknown
   {
      ...
      function get musicController() : class_3187;
      
      function playSound(param1:String, param2:int = 0) : void;
      
      function stopSound(param1:String) : void;
      
      function playSoundAtPitch(param1:String, param2:Number) : class_3153;
      
      function loadTraxSong(param1:int, param2:String) : class_3153;
