package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_1130:int = 5;
      
      public static const const_881:int = 6;
      ...
      private var var_3563:Dictionary;
      
      public function WindowTracker()
      {
         var_3563 = new Dictionary();
         super();
      }
      
      public function show(param1:ITrackedWindow, param2:class_3281, param3:Boolean, param4:Boolean, param5:Boolean, param6:Boolean = false, param7:int = 0, param8:int = 0, param9:int = 0, param10:int = 0) : void
      {
      ...
      {
         var _loc2_:Dictionary = var_3563[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            var_3563[param1] = _loc2_;
         }
         return _loc2_;
      }
   }
