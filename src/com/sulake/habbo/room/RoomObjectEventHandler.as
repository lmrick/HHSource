package com.sulake.habbo.room
{
   ...
   import package_13.ClickFurniMessageComposer;
   import package_13.class_1034;
   import package_13.class_164;
   import package_13.class_211;
   import package_13.class_213;
   import package_13.class_225;
   import package_13.class_282;
   import package_13.class_432;
   import package_13.class_560;
   import package_13.class_585;
   import package_13.class_625;
   import package_13.class_627;
   import package_13.class_715;
   import package_13.class_744;
   import package_13.class_796;
   import package_13.class_961;
   import package_21.class_1005;
   import package_21.class_199;
   import package_21.class_385;
   import package_21.class_404;
   import package_21.class_665;
   import package_21.class_691;
   import package_21.class_909;
   import package_30.class_646;
   import package_34.class_621;
   
   public class RoomObjectEventHandler implements IRoomRenderingCanvasMouseListener
   {
       
      
      private var _roomEngine:com.sulake.habbo.room.class_1678 = null;
      
      private var var_2307:class_24 = null;
      
      private var var_2917:int = -1;
      
      private var var_2715:int = -1;
      
      private var var_3329:int = -2;
      
      private var var_3888:Boolean = true;
      
      private var var_4224:String;
      
      public function RoomObjectEventHandler(param1:com.sulake.habbo.room.class_1678)
      {
         super();
         var_2307 = new class_24();
         _roomEngine = param1;
      }
      
      protected function get roomEngine() : com.sulake.habbo.room.class_1678
      {
         return _roomEngine;
      }
      ...
      public function initializeRoomObjectInsert(param1:String, param2:int, param3:int, param4:int, param5:int, param6:String = null, param7:IStuffData = null, param8:int = -1, param9:int = -1, param10:String = null) : Boolean
      {
         var_4224 = param1;
         var _loc11_:IVector3d = new Vector3d(-100,-100);
         var _loc12_:IVector3d = new Vector3d(0);
         setSelectedObjectData(param2,param3,param4,_loc11_,_loc12_,"OBJECT_PLACE",param5,param6,param7,param8,param9,param10);
         if(_roomEngine != null)
         {
      ...
      private function getSelectedObjectData(param1:int) : class_3190
      {
         if(_roomEngine == null)
         {
            return null;
      ...
      private function setSelectedObjectData(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:String, param7:int = 0, param8:String = null, param9:IStuffData = null, param10:int = -1, param11:int = -1, param12:String = null) : void
      {
         ...
         var _loc13_:class_3190 = new class_3190(param2,param3,param6,param4,param5,param7,param8,param9,param10,param11,param12);
      ...
      private function resetSelectedObjectData(param1:int) : void
      {
         ...
         var _loc2_:class_3190 = getSelectedObjectData(param1);
         if(_loc2_ != null)
         {
      ...
      private function deselectObject(param1:int) : void
      {
         ...
         if(var_2715 != -1)
         {
            _loc2_ = _roomEngine.getRoomObject(param1,var_2715,var_3329) as IRoomObjectController;
      ...
      public function processRoomCanvasMouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomObject, param3:IRoomGeometry) : void
      {
         ...
         var _loc7_:String = param2.getType();
         var _loc6_:int;
         var _loc4_:* = _loc6_ = _roomEngine.getRoomObjectCategory(_loc7_);
         if(_loc6_ != 0)
         {
         ...
         var _loc5_:String;
         if((_loc5_ = getMouseEventId(_loc6_,param1.type)) == param1.eventId)
         {
         ...
         {
            setMouseEventId(_loc6_,param1.type,param1.eventId);
         }
      ...
      {
         var _loc4_:class_24;
         if((_loc4_ = var_2307.getValue(String(param1)) as class_24) == null)
         {
            _loc4_ = new class_24();
            var_2307.add(param1,_loc4_);
         }
      ...
      private function clickRoomObject(param1:RoomObjectMouseEvent) : void
      {
         ...
         if(_roomEngine != null && false && _loc2_ == 10)
         {
      ...
      private function handleRoomObjectMouseClick(param1:RoomObjectMouseEvent, param2:int) : void
      {
         ...
         switch(_loc5_)
         {
            ...
            case "OBJECT_UNDEFINED":
               ...
               {
                  if((param1.altKey || param1.ctrlKey || param1.shiftKey) && true)
                  {
                     ...
                     {
                        modifyRoomObject(param2,_loc15_,_loc14_,"OBJECT_PICKUP");
                     }
                     if(!_roomEngine.getActiveRoomIsPlayingGame())
                     {
                        _loc9_ = true;
      ...
      private function handleMouseOverTile(param1:RoomObjectTileMouseEvent, param2:int) : RoomObjectTileCursorUpdateMessage
      {
         ...
         var _loc3_:class_3280 = null;
         var _loc8_:IRoomObject = null;
         var _loc4_:class_3196 = null;
      ...
      private function handleRoomObjectMouseDown(param1:RoomObjectMouseEvent, param2:int) : void
      {
         ...
         if("OBJECT_UNDEFINED" === _loc9_)
         {
            ...
            {
               if((param1.altKey && !param1.ctrlKey && !param1.shiftKey || decorateModeMove(param1)) && true)
               {
         ...
         if((_loc8_ = _roomEngine.events) != null)
         {
            switch(param1.type)
            {
               ...
               case "ROWRE_GUILD_FURNI_CONTEXT_MENU":
                  ...
                  _roomEngine.connection.send(new class_909(param1.objectId,_loc6_));
                  break;
               case "ROWRE_MONSTERPLANT_SEED_PLANT_CONFIRMATION_DIALOG":
               ...
               case "ROWRE_MYSTERYTROPHY_OPEN_DIALOG":
                  ...
                  break;
               case "ROWRE_ACHIEVEMENT_RESOLUTION_OPEN":
                  _roomEngine.connection.send(new class_646(param1.objectId,0));
                  break;
               case "ROWRE_ACHIEVEMENT_RESOLUTION_ENGRAVING":
         ...
         switch(param1.type)
         {
            case "RORAE_ROOM_AD_FURNI_CLICK":
               ...
               if(_loc5_ != null && false)
               {
                  ...
                  {
                     (_roomEngine as class_20).context.createLinkEvent(_loc5_.clickUrl);
                  }
               }
      ...
      private function handleObjectDimmerStateEvent(param1:RoomObjectEvent, param2:int) : void
      {
         ...
         if(_roomEngine != null && false)
         {
            ...
            if("RODSUE_DIMMER_STATE" === _loc6_)
            {
               ...
               {
                  _loc3_ = new RoomEngineDimmerStateEvent(param2,_loc4_.state,_loc4_.presetId,_loc4_.effectId,_loc4_.color,_loc4_.brightness);
      ...
      private function handleFurnitureMove(param1:IRoomObjectController, param2:class_3190, param3:int, param4:int, param5:class_3196) : Boolean
      {
         if(param1 == null || param2 == null)
         {
            return false;
      ...
      private function handleWallItemMove(param1:IRoomObjectController, param2:class_3190, param3:IVector3d, param4:IVector3d, param5:IVector3d, param6:Number, param7:Number, param8:Number) : Boolean
      {
         if(param1 == null || param2 == null)
         {
            return false;
      ...
      private function handleUserPlace(param1:IRoomObjectController, param2:int, param3:int, param4:class_3155) : Boolean
      {
      ...
      private function validateFurnitureDirection(param1:IRoomObject, param2:IVector3d, param3:class_3196) : Boolean
      {
         var _loc11_:* = false;
      ...
      private function validateFurnitureLocation(param1:IRoomObject, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:class_3196) : Vector3d
      {
      ...
      private function validateWallItemLocation(param1:IRoomObject, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Number, param6:Number, param7:class_3190) : Vector3d
      {
      ...
      public function setSelectedAvatar(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         if((_loc7_ = _roomEngine.getRoomObject(param1,var_2917,100) as IRoomObjectController) != null && _loc7_.getEventHandler() != null)
         {
         ...
         if(param3)
         {
            if((_loc7_ = _roomEngine.getRoomObject(param1,param2,100) as IRoomObjectController) != null && _loc7_.getEventHandler() != null)
            {
               ...
               try
               {
                  _roomEngine.connection.send(new class_621(_loc7_.getLocation().x,_loc7_.getLocation().y));
               }
               catch(e:Error)
               {
               }
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:int, param4:String, param5:class_24) : Boolean
      {
         if(_roomEngine == null)
         {
            return false;
         ...
         {
            _roomEngine.connection.send(new class_625(param2,param5));
         }
         return true;
      }
      ...
      {
         var _loc6_:class_3190 = null;
         var _loc7_:int = 0;
         var _loc12_:class_3155 = null;
         ...
         switch(param4)
         {
            ...
            case "OBJECT_ROTATE_NEGATIVE":
               if(false)
               {
                  ...
                  if(validateFurnitureDirection(_loc13_,new Vector3d(_loc14_),_roomEngine.getFurniStackingHeightMap(param1)))
                  {
                     ...
                     {
                        if((_loc15_ = _roomEngine.roomSessionManager.getSession(param1)) != null)
                        {
                           if((_loc5_ = _loc15_.userDataManager.getUserDataByIndex(param2)) != null)
                           {
                              _roomEngine.connection.send(new class_432(_loc5_.webID,_loc8_,_loc10_,_loc14_));
                              break;
                           }
                           break;
                        }
                     ...
                     _roomEngine.connection.send(new class_585(param2,_loc8_,_loc10_,_loc14_));
                     break;
                  }
                  break;
               }
            ...
            case "OBJECT_PICKUP":
               if(false)
               {
                  _roomEngine.connection.send(new class_211(param2,param3));
                  break;
               }
               break;
            ...
            case "OBJECT_PICKUP_BOT":
               if(false)
               {
                  if((_loc15_ = _roomEngine.roomSessionManager.getSession(param1)) != null)
                  {
                     if((_loc5_ = _loc15_.userDataManager.getUserDataByIndex(param2)) != null)
                     {
                        _roomEngine.connection.send(new class_282(_loc5_.webID));
                        break;
                     }
                     break;
                  }
                  ...
                  if(param3 == 20)
                  {
                     ...
                     if(false && _loc12_)
                     {
                        if((_loc9_ = _loc12_.getOldLocationString(_loc13_.getLocation(),_loc14_)) != null)
                        {
                           ...
                           _roomEngine.connection.send(new class_744(param2,20,_loc9_));
                           break;
                        }
                        break;
                     }
      ...
      private function placeObject(param1:int, param2:Boolean, param3:Boolean) : void
      {
         ...
         var _loc16_:class_3155 = null;
         var _loc9_:Boolean = false;
         var _loc5_:class_3190;
         ...
         if(_roomEngine != null && false)
         {
            if((_loc6_ = _roomEngine.getRoomObject(param1,_loc14_,_loc15_) as IRoomObjectController) != null)
            {
               ...
               if(true || _roomEngine.catalog.catalogType == "NORMAL" || var_4224 != "catalog")
               {
                  if(_loc15_ == 100 && _loc5_.typeId == 2)
                  {
                     _roomEngine.connection.send(new class_715(_loc14_,int(_loc10_),int(_loc12_)));
                  }
                  else if(_loc15_ == 100 && _loc5_.typeId == 4)
                  {
                     _roomEngine.connection.send(new class_1034(_loc14_,int(_loc10_),int(_loc12_)));
                  }
                  else if(_loc6_.getModelController().getString("furniture_is_stickie") != null)
                  {
                     _roomEngine.connection.send(new class_691(_loc14_,_loc11_));
                  }
                  else
                  {
                     _roomEngine.connection.send(new class_627(_loc14_,_loc15_,_loc11_,int(_loc10_),int(_loc12_),_loc7_));
                  }
               }
            }
         }
         var _loc8_:class_3190 = new class_3190(_loc5_.id,_loc5_.category,null,null,null);
      ...
      private function changeRoomObjectState(param1:int, param2:int, param3:int, param4:int, param5:Boolean) : Boolean
      {
         ...
         if(_roomEngine != null && false)
         {
            if(param3 == 10)
            {
               if(!param5)
               {
                  _roomEngine.connection.send(new class_560(param2,param4));
               }
               else
               {
                  _roomEngine.connection.send(new class_665(param2,param4));
               }
            }
            else if(param3 == 20)
            {
               _roomEngine.connection.send(new class_796(param2,param4));
            }
            if((_loc6_ = _roomEngine.roomSessionManager.getSession(param1)) != null)
            {
               _loc6_.trackEventLogOncePerSession("Achievements","interaction","furniture.use");
            }
         }
         return true;
      }
      ...
      private function useObject(param1:int, param2:int, param3:String, param4:String) : void
      {
         if(_roomEngine != null && false)
         {
            ...
            {
               case "ROFCAE_DICE_ACTIVATE":
                  _roomEngine.connection.send(new class_1005(param2));
                  break;
               case "ROFCAE_DICE_OFF":
                  _roomEngine.connection.send(new class_385(param2));
                  break;
               case "ROFCAE_USE_HABBOWHEEL":
                  _roomEngine.connection.send(new class_404(param2));
                  break;
               case "ROFCAE_STICKIE":
                  _roomEngine.connection.send(new class_225(param2));
                  break;
               case "ROFCAE_ENTER_ONEWAYDOOR":
                  _roomEngine.connection.send(new class_199(param2));
            }
         }
      }
      ...
      public function modifyWallItemData(param1:int, param2:int, param3:String, param4:String) : Boolean
      {
         ...
         _roomEngine.connection.send(new class_164(param2,param3,param4));
         return true;
      }
      ...
      public function deleteWallItem(param1:int, param2:int) : Boolean
      {
         ...
         _roomEngine.connection.send(new class_961(param2));
         return true;
      }
      ...
      private function walkTo(param1:int, param2:int) : void
      {
         if(false)
         {
            _roomEngine.connection.send(new class_213(param1,param2));
         }
      }
