package com.sulake.habbo.room
{
   ...
   import com.sulake.core.utils.class_3253;
   ...
   import com.sulake.habbo.room.utils.class_1655;
   import com.sulake.habbo.room.utils.class_3128;
   import com.sulake.habbo.room.utils.class_3138;
   ...
   import com.sulake.habbo.room.utils.class_3240;
   import com.sulake.habbo.room.utils.class_3265;
   import com.sulake.habbo.room.utils.class_3267;
   ...
   public class RoomEngine extends class_20 implements IRoomEngine, IRoomManagerListener, class_1677, class_1678, class_41, class_1679
   {
      ...
      public static const const_438:uint = 5;
      ...
      private static const const_639:String = "selection_arrow";
      
      private static const const_954:String = "overlay";
      
      private static const const_828:String = "object_icon_sprite";
      
      private static const ROOM_DRAG_THRESHOLD:int = 15;
      
      private static const const_1060:int = 40;
      ...
      private var var_1504:com.sulake.habbo.room.class_3198 = null;
      
      private var var_1949:com.sulake.habbo.room.class_3145 = null;
      
      private var var_1434:com.sulake.habbo.room.class_3161 = null;
      
      private var var_4265:Boolean = false;
      
      private var var_2322:NumberBank;
      
      private var var_3151:class_24;
      
      private var var_2361:NumberBank;
      
      private var var_2459:class_24;
      
      private var var_1981:Boolean = false;
      
      protected var var_1467:int = 0;
      
      private var var_2194:int = -1;
      
      private var var_3468:int = 0;
      
      private var var_3316:int = 0;
      ...
      private var var_1853:class_24 = null;
      
      private var var_1759:class_24 = null;
      
      private var _skipFurnitureCreationForNextFrame:Boolean = false;
      
      private var _mouseCursorUpdate:Boolean;
      
      private var var_1838:class_24 = null;
      ...
      private var var_4338:int = 0;
      
      private var var_3105:int = 0;
      
      public function RoomEngine(param1:class_31, param2:uint = 0)
      {
         super(param1,param2);
      }
      ...
      protected function get eventHandler() : com.sulake.habbo.room.class_3198
      {
         return var_1504;
      }
      ...
      public function get gameEngine() : class_1688
      {
         return _gameManager;
      }
      ...
      override protected function get dependencies() : Vector.<ComponentDependency>
      {
         ...
         }]),new ComponentDependency(new IIDHabboAdManager(),function(param1:class_1694):void
         {
            _adManager = param1;
         },false,[{
         ...
         {
            _gameManager = param1;
         },(flags & 4) == 0),new ComponentDependency(new IIDHabboWindowManager(),function(param1:class_1684):void
         {
      ...
      {
         var_1759 = new class_24();
         var_2322 = new NumberBank(1000);
         var_2361 = new NumberBank(1000);
         var_3151 = new class_24();
         var_2459 = new class_24();
         var_1853 = new class_24();
         var_1504 = createRoomObjectEventHandlerInstance();
         var_1949 = new com.sulake.habbo.room.class_3145(this);
      ...
      private function onConfigurationComplete(param1:Event) : void
      {
         ...
         var_1434 = new com.sulake.habbo.room.class_3161(_loc3_.loaderURL);
         var_1434.initialize(events,this);
         var_1434.iconAssets = assets;
         var_1434.iconListener = this;
         var_1434.visualizationFactory = _visualizationFactory;
         ...
         _roomManager.setContentLoader(var_1434);
         if(var_1949 && _communication)
         {
            var_1949.connection = _communication.connection;
         }
         _roomDraggingAlwaysCenters = getBoolean("room.dragging.always_center");
         var_1434.sessionDataManager = _sessionDataManager;
         events.addEventListener("RCL_LOADER_READY",onContentLoaderReady);
      }
      
      protected function createRoomObjectEventHandlerInstance() : com.sulake.habbo.room.class_3198
      {
         return new com.sulake.habbo.room.class_3198(this);
      }
      
      override public function dispose() : void
      {
         var _loc2_:int = 0;
         var _loc1_:class_3128 = null;
         if(disposed)
         {
            return;
         }
         ...
         {
            _loc2_ = 0;
            while(_loc2_ < var_1759.length)
            {
               _loc1_ = var_1759.getWithIndex(_loc2_) as class_3128;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      private function getRoomInstanceData(param1:int) : class_3128
      {
         var _loc2_:String = getRoomIdentifier(param1);
         var _loc3_:class_3128 = null;
         if(var_1759 != null)
         {
            _loc3_ = var_1759.getValue(_loc2_) as class_3128;
            if(_loc3_ == null)
            {
               _loc3_ = new class_3128(param1);
               var_1759.add(_loc2_,_loc3_);
            }
         }
         return _loc3_;
      }
      
      public function setFurniStackingHeightMap(param1:int, param2:class_3196) : void
      {
         var _loc3_:class_3128 = getRoomInstanceData(param1);
         if(_loc3_ != null)
         {
      ...
      public function getFurniStackingHeightMap(param1:int) : class_3196
      {
         var _loc2_:class_3128 = getRoomInstanceData(param1);
         if(_loc2_ != null)
         {
      ...
      public function getLegacyGeometry(param1:int) : class_3155
      {
         var _loc2_:class_3128 = getRoomInstanceData(param1);
         if(_loc2_ != null)
         {
      ...
      public function getTileObjectMap(param1:int) : class_3280
      {
         var _loc2_:class_3128 = getRoomInstanceData(param1);
         if(_loc2_ != null)
         {
      ...
      private function getActiveRoomCamera() : class_3138
      {
         return getRoomCamera(var_1467);
      }
      
      private function getRoomCamera(param1:int) : class_3138
      {
         var _loc2_:class_3128 = getRoomInstanceData(param1);
         if(_loc2_ != null)
         {
      ...
      public function setSelectedObjectData(param1:int, param2:class_3190) : void
      {
         var _loc3_:class_3128 = getRoomInstanceData(param1);
         if(_loc3_ != null)
         {
      ...
      public function setPlacedObjectData(param1:int, param2:class_3190) : void
      {
         var _loc3_:class_3128 = getRoomInstanceData(param1);
         if(_loc3_ != null)
         {
      ...
      private function updateMouseCursor() : void
      {
         ...
         var _loc1_:class_3128 = getRoomInstanceData(var_1467);
      ...
      public function requestMouseCursor(param1:String, param2:int, param3:String) : void
      {
         ...
         if("ROFCAE_MOUSE_BUTTON" !== _loc5_)
         {
            ...
            removeButtonMouseCursorOwner(var_1467,_loc4_,param2);
         }
         else
         {
            if(isGameMode && _loc4_ == 100)
            ...
            addButtonMouseCursorOwner(var_1467,_loc4_,param2);
         }
      }
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         var _loc8_:int = 0;
         var _loc3_:class_3128 = null;
         var _loc7_:class_3138 = null;
         var _loc9_:int = 0;
         var _loc6_:int = 0;
         var _loc4_:int = 0;
         var _loc10_:IRoomObject = null;
         _loc8_ = 0;
         while(_loc8_ < var_1759.length)
         {
            _loc3_ = var_1759.getWithIndex(_loc8_) as class_3128;
            _loc7_ = null;
            _loc9_ = 0;
            if(_loc3_ != null)
            {
               _loc7_ = _loc3_.roomCamera;
               _loc9_ = _loc3_.roomId;
            }
            if(_loc7_ != null)
            {
               _loc6_ = _loc7_.targetId;
               _loc4_ = _loc7_.targetCategory;
               if((_loc10_ = getRoomObject(_loc9_,_loc6_,_loc4_)) != null)
               {
                  if(_loc9_ != var_1467 || !var_2211)
                  {
                     updateRoomCamera(_loc9_,1,_loc10_.getLocation(),param1);
                  }
               }
            }
            _loc8_++;
         ...
         if((_loc5_ = getRoomCanvas(var_1467,1)) != null)
         {
            if(var_2211)
            {
               _loc5_.screenOffsetX += var_2904;
               _loc5_.screenOffsetY += var_2909;
               var_2904 = 0;
               var_2909 = 0;
            }
         }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case "RSE_STARTED":
               if(var_1949)
               {
                  var_1949.setCurrentRoom(param1.session.roomId);
                  break;
               }
               break;
            case "RSE_ENDED":
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:class_1655 = null;
         if(param1)
         {
            var_1981 = true;
            events.dispatchEvent(new RoomEngineEvent("REE_ENGINE_INITIALIZED",0));
            _loc3_ = 0;
            while(_loc3_ < var_1853.length)
            {
               _loc2_ = var_1853.getWithIndex(_loc3_) as class_1655;
               if(_loc2_ != null)
               {
      ...
      {
         return getIsPlayingGame(var_1467);
      }
            ...
            if(param2 != null)
            {
               if(param2.doors.door.length() > 0)
               {
                  ...
                  while(_loc20_ < _loc17_.length())
                  {
                     ...
                     if(class_1667.checkRequiredAttributes(_loc7_,_loc27_))
                     {
      ...
      public function updateObjectRoom(param1:int, param2:String = null, param3:String = null, param4:String = null, param5:Boolean = false) : Boolean
      {
         ...
         if(_loc10_ == null)
         {
            ...
            if((_loc8_ = var_1853.getValue(_loc6_)) == null)
            {
               _loc8_ = new class_1655(param1,null);
               var_1853.add(_loc6_,_loc8_);
            }
            if(param2 != null)
            {
      ...
      public function disposeRoom(param1:int) : void
      {
         ...
         var _loc3_:class_3128 = var_1759.remove(_loc2_);
         if(_loc3_ != null)
         {
            _loc3_.dispose();
         }
      ...
      {
         var _loc10_:class_3128 = null;
         var _loc11_:class_3138 = null;
         ...
         if((_loc9_ = getRoomCanvas(param1,param2)) != null)
         {
            ...
            if((_loc10_ = getRoomInstanceData(var_1467)) != null)
            {
      ...
      private function handleRoomDragging(param1:IRoomRenderingCanvas, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         ...
         var _loc9_:int = param2 - var_3468;
         var _loc8_:int = param3 - var_3316;
         if(param4 == "mouseDown")
         {
         ...
         else if(param4 == "mouseUp")
         {
            if(var_2211)
            {
               ...
               if(var_1939)
               {
                  ...
                  events.dispatchEvent(new RoomEngineDragWithMouseEvent("REDWME_DRAG_END",var_1467));
               }
            }
            if(var_3105 != 0)
            {
         ...
         else if(param4 == "mouseMove")
         {
            if(var_2211)
            {
               if(!var_1939)
               {
                  _loc9_ = param2 - var_3970;
                  _loc8_ = param3 - var_4007;
                  if(_loc9_ <= -15 || _loc9_ >= 15 || _loc8_ <= -15 || _loc8_ >= 15)
                  {
                     var_1939 = true;
                     events.dispatchEvent(new RoomEngineDragWithMouseEvent("REDWME_DRAG_START",var_1467));
                  }
                  _loc9_ = 0;
                  _loc8_ = 0;
               }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         if(var_3457 > 0 && param3 < var_3457)
         {
            return;
         }
         if(var_2167 > 0 && param2 < var_2167)
         {
            return;
         }
         var _loc9_:IRoomRenderingCanvas;
         if((_loc9_ = getRoomCanvas(var_1467,param1)) != null)
         {
            if(_sessionDataManager.isPerkAllowed("MOUSE_ZOOM") && param4 == "click" && param6 && param5)
            {
               ...
               setRoomCanvasScale(activeRoomId,var_2194,_loc12_,new Point(param2,param3));
               return;
            }
            ...
            if(!handleRoomDragging(_loc9_,param2,param3,param4,param5,param6,param7))
            {
               if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
               {
                  ...
                  if(param4 == "click")
                  {
                     if(events != null)
                     {
                        events.dispatchEvent(new RoomEngineObjectEvent("REOE_DESELECTED",var_1467,-1,-2));
                     }
                  ...
                  if(var_1504 != null)
                  {
                     _loc13_ = new RoomObjectMouseEvent(_loc14_,getRoomObject(var_1467,-1,0),null,param5);
                     var_1504.handleRoomObjectEvent(_loc13_,var_1467);
                  }
               }
            }
            var_2194 = param1;
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null, param5:IStuffData = null, param6:int = -1, param7:int = -1, param8:String = null) : void
      {
         ...
         if(param3)
         {
            _loc15_ = getRoomObjectImage(var_1467,param1,param2,new Vector3d(),1,null);
         }
         else if(var_1434 != null)
         {
            _loc13_ = null;
            _loc12_ = 0;
            if(param2 == 10)
            {
               _loc13_ = var_1434.getActiveObjectType(param1);
               _loc12_ = var_1434.getActiveObjectColorIndex(param1);
            }
            else if(param2 == 20)
            {
               _loc13_ = var_1434.getWallItemType(param1,param4);
               _loc12_ = var_1434.getWallItemColorIndex(param1);
            }
            if(param2 == 100)
            {
         ...
         if((_loc9_ = getActiveRoomActiveCanvas()) != null)
         {
            ...
            {
               _loc11_.x = var_3468 - _loc15_.data.width / 2;
               _loc11_.y = var_3316 - _loc15_.data.height / 2;
            }
         }
      }
      ...
      public function getObjectsByCategory(param1:int) : Array
      {
         ...
         if(_roomManager != null)
         {
            _loc2_ = _roomManager.getRoom(getRoomIdentifier(var_1467));
         }
         if(_loc2_ == null)
         {
            return [];
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_1504 != null)
         {
            return var_1504.modifyRoomObject(var_1467,param1,param2,param3);
         }
         return false;
      }
      
      public function modifyRoomObjectDataWithMap(param1:int, param2:int, param3:String, param4:class_24) : Boolean
      {
         if(var_1504 != null)
         {
            if(param2 == 10)
            {
               return var_1504.modifyRoomObjectData(var_1467,param1,param2,param3,param4);
            }
         }
         return false;
      }
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String, param4:String) : Boolean
      {
         if(var_1504 != null)
         {
            if(param2 == 20)
            {
               return var_1504.modifyWallItemData(var_1467,param1,param3,param4);
            }
         }
         return false;
      }
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(var_1504 != null)
         {
            if(param2 == 20)
            {
               return var_1504.deleteWallItem(var_1467,param1);
            }
         }
         return false;
      }
      
      public function initializeRoomObjectInsert(param1:String, param2:int, param3:int, param4:int, param5:String = null, param6:IStuffData = null, param7:int = -1, param8:int = -1, param9:String = null) : Boolean
      {
         var _loc10_:IRoomInstance;
         if((_loc10_ = getRoom(var_1467)) == null || _loc10_.getNumber("room_is_public") != 0)
         {
            return false;
         }
         if(var_1504 != null)
         {
            return var_1504.initializeRoomObjectInsert(param1,var_1467,param2,param3,param4,param5,param6,param7,param8,param9);
         }
         return false;
      }
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(var_1504 != null)
         {
            var_1504.cancelRoomObjectInsert(var_1467);
         }
      }
      ...
      public function useRoomObjectInActiveRoom(param1:int, param2:int) : Boolean
      {
         ...
         if((_loc4_ = getRoomObject(var_1467,param1,param2)) != null)
         {
      ...
      private function getRoomObjectAdURL(param1:String) : String
      {
         if(var_1434 != null)
         {
            return var_1434.getRoomObjectAdURL(param1);
         }
         return "";
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(var_1434 != null)
         {
            var_1434.setRoomObjectAlias(param1,param2);
         }
      }
      ...
      public function getRoomObjectCategory(param1:String) : int
      {
         if(var_1434 != null)
         {
            return var_1434.getObjectCategory(param1);
         }
         return -2;
      }
      ...
      public function getFurnitureType(param1:int) : String
      {
         if(var_1434 != null)
         {
            return var_1434.getActiveObjectType(param1);
         }
         return "";
      }
      ...
      public function getFurnitureTypeId(param1:String) : int
      {
         if(var_1434 != null)
         {
            return var_1434.getActiveObjectTypeId(param1);
         }
         return 0;
      }
      ...
      public function getWallItemType(param1:int, param2:String = null) : String
      {
         if(var_1434 != null)
         {
            return var_1434.getWallItemType(param1,param2);
         }
         return "";
      }
      ...
      private function getPetType(param1:String) : String
      {
         ...
         if(param1 != null)
         {
            ...
            if(_loc2_.length > 1)
            {
               ...
               if(var_1434 != null)
               {
                  return var_1434.getPetType(_loc3_);
               }
               return "pet";
            }
         }
      ...
      public function getPetColor(param1:int, param2:int) : PetColorResult
      {
         if(var_1434 != null)
         {
            return var_1434.getPetColor(param1,param2);
         }
         return null;
      }
      ...
      public function getPetColorsByTag(param1:int, param2:String) : Array
      {
         if(var_1434 != null)
         {
            return var_1434.getPetColorsByTag(param1,param2);
         }
         return null;
      }
      ...
      public function getPetLayerIdForTag(param1:int, param2:String) : int
      {
         if(var_1434 != null)
         {
            return var_1434.getPetLayerIdForTag(param1,param2);
         }
         return -1;
      }
      ...
      public function getPetDefaultPalette(param1:int, param2:String) : PetColorResult
      {
         if(var_1434 != null)
         {
            return var_1434.getPetDefaultPalette(param1,param2);
         }
         return null;
      }
      ...
      private function getFurnitureColorIndex(param1:int) : int
      {
         if(var_1434 != null)
         {
            return var_1434.getActiveObjectColorIndex(param1);
         }
         return 0;
      }
      ...
      private function getWallItemColorIndex(param1:int) : int
      {
         if(var_1434 != null)
         {
            return var_1434.getWallItemColorIndex(param1);
         }
         return 0;
      }
      ...
      {
         var _loc17_:class_3265 = null;
         var _loc16_:class_3128;
         if((_loc16_ = getRoomInstanceData(param1)) != null)
         {
            _loc17_ = new class_3265(param2,param3,null,param4,param5,param6,param7,param8,param9,param10,param11,param12,param13,param14,param15);
      ...
      {
         var _loc11_:class_3265 = null;
         var _loc9_:String = getWorldType(param1);
         var _loc10_:class_3128;
         if((_loc10_ = getRoomInstanceData(param1)) != null)
         {
            _loc11_ = new class_3265(param2,0,param3,param4,param5,param6,param7,param8,0);
            _loc10_.addFurnitureData(_loc11_);
         }
         return true;
      }
      
      private function addObjectFurnitureFromData(param1:int, param2:int, param3:class_3265) : Boolean
      {
         var _loc4_:class_3128 = null;
         if(param3 == null)
         {
      ...
      public function changeObjectState(param1:int, param2:int, param3:int) : void
      {
         ...
         if((_loc8_ = getObject(getRoomIdentifier(param1),param2,param3)) != null && _loc8_.getModelController() != null)
         {
            ...
            (_loc4_ = class_1588.getStuffDataWrapperForType(_loc5_)).initializeFromRoomObjectModel(_loc8_.getModel());
      ...
      public function updateObjectFurnitureLocation(param1:int, param2:int, param3:IVector3d, param4:IVector3d, param5:Number = NaN) : Boolean
      {
         var _loc6_:RoomObjectMoveUpdateMessage = null;
         var _loc7_:IRoomObjectController;
         if((_loc7_ = getObjectFurniture(param1,param2)) == null)
         {
            return false;
         }
         if(_loc7_ != null && _loc7_.getEventHandler() != null)
      ...
      public function disposeObjectFurniture(param1:int, param2:int, param3:int = -1, param4:Boolean = false) : void
      {
         ...
         var _loc6_:class_3128;
         if((_loc6_ = getRoomInstanceData(param1)) != null)
         {
            _loc6_.getFurnitureDataWithId(param2);
         }
         if(_sessionDataManager && param3 == _sessionDataManager.userId && !class_3288.isBuilderClubId(param2))
         {
            if(_loc14_ = getRoomObject(param1,param2,10))
            {
               if(_loc12_ = getRoomObjectScreenLocation(param1,param2,10,var_2194))
               {
                  _loc10_ = (_loc9_ = _loc14_.getModel()).getNumber("furniture_disable_picking_animation") == 1;
                  if((_loc9_ = _loc14_.getModel()).getNumber("furniture_disable_picking_animation") != 1)
                  {
                     ...
                     _loc8_ = class_1588.getStuffDataWrapperForType(_loc13_);
      ...
      {
         var _loc15_:class_1610 = null;
         var _loc14_:class_3265 = null;
         var _loc13_:class_3128;
         if((_loc13_ = getRoomInstanceData(param1)) != null)
         {
            (_loc15_ = new class_1610()).setString(param7);
            _loc14_ = new class_3265(param2,param3,null,param4,param5,param6,_loc15_,NaN,param11,param8,param9,param10,true,param12);
            _loc13_.addWallItemData(_loc14_);
         }
         return true;
      }
      
      private function addObjectWallItemFromData(param1:int, param2:int, param3:class_3265) : Boolean
      {
         var _loc4_:class_3128 = null;
         if(param3 == null)
         {
      ...
      public function updateObjectWallItem(param1:int, param2:int, param3:IVector3d, param4:IVector3d, param5:int, param6:String) : Boolean
      {
         ...
         var _loc8_:RoomObjectUpdateMessage = new RoomObjectUpdateMessage(param3,param4);
         var _loc7_:class_1610;
         (_loc7_ = new class_1610()).setString(param6);
      ...
      public function updateObjectWallItemLocation(param1:int, param2:int, param3:IVector3d) : Boolean
      {
         var _loc4_:RoomObjectMoveUpdateMessage = null;
         var _loc5_:IRoomObjectController;
         if((_loc5_ = getObjectWallItem(param1,param2)) == null)
         {
            return false;
         ...
         {
            _loc4_ = new RoomObjectMoveUpdateMessage(param3,null,null);
            _loc5_.getEventHandler().processUpdateMessage(_loc4_);
         }
         updateObjectRoomWindow(param1,param2);
         return true;
      ...
      public function disposeObjectWallItem(param1:int, param2:int, param3:int = -1) : void
      {
         ...
         if(_sessionDataManager && param3 == _sessionDataManager.userId && !class_3288.isBuilderClubId(param2))
         {
            ...
            {
               _loc6_ = getRoomObjectScreenLocation(param1,param2,20,var_2194);
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         ...
         if(var_1504 != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               var_1504.handleRoomObjectEvent(param1,_loc3_);
            }
         }
      }
      ...
      public function createScreenShot(param1:int, param2:int, param3:String) : void
      {
         ...
         if(class_3253.isVersionAtLeast(11,3))
         {
         }
         if(_loc10_ == null)
         {
            _loc10_ = class_3146.encode(_loc8_);
         }
         try
         {
      ...
      public function getFurnitureIconUrl(param1:int) : String
      {
         ...
         if(var_1434 != null)
         {
            _loc3_ = var_1434.getActiveObjectType(param1);
            _loc2_ = String(var_1434.getActiveObjectColorIndex(param1));
         }
         return var_1434.getObjectUrl(_loc3_,_loc2_);
      }
      
      public function getFurnitureIcon(param1:int, param2:class_3158, param3:String = null, param4:IStuffData = null, param5:Boolean = false) : class_3266
      {
      ...
      public function getWallItemIconUrl(param1:int, param2:String = null) : String
      {
         ...
         if(var_1434 != null)
         {
            _loc4_ = var_1434.getWallItemType(param1,param2);
            _loc3_ = String(var_1434.getWallItemColorIndex(param1));
         }
         return var_1434.getObjectUrl(_loc4_,_loc3_);
      }
      
      public function getWallItemIcon(param1:int, param2:class_3158, param3:String = null) : class_3266
      {
         return getWallItemImage(param1,new Vector3d(),1,param2,0,param3);
      }
      
      public function getFurnitureImage(param1:int, param2:IVector3d, param3:int, param4:class_3158, param5:uint = 0, param6:String = null, param7:int = -1, param8:int = -1, param9:IStuffData = null, param10:Boolean = false) : class_3266
      {
         var _loc12_:String = null;
         var _loc11_:String = "";
         if(var_1434 != null)
         {
            _loc12_ = var_1434.getActiveObjectType(param1);
            _loc11_ = String(var_1434.getActiveObjectColorIndex(param1));
         }
      ...
      public function getPetImage(param1:int, param2:int, param3:int, param4:IVector3d, param5:int, param6:class_3158, param7:Boolean = true, param8:uint = 0, param9:Array = null, param10:String = null) : class_3266
      {
         ...
         if(var_1434 != null)
         {
            _loc11_ = var_1434.getPetType(param1);
         }
         return getGenericRoomObjectImage(_loc11_,_loc13_,param4,param5,param6,param8,null,null,-1,-1,param10);
      }
      
      public function getWallItemImage(param1:int, param2:IVector3d, param3:int, param4:class_3158, param5:uint = 0, param6:String = null, param7:int = -1, param8:int = -1) : class_3266
      {
         var _loc10_:String = null;
         var _loc9_:String = "";
         if(var_1434 != null)
         {
            _loc10_ = var_1434.getWallItemType(param1,param6);
            _loc9_ = String(var_1434.getWallItemColorIndex(param1));
         }
      ...
      public function getRoomImage(param1:String, param2:String, param3:String, param4:int, param5:class_3158, param6:String = null) : class_3266
      {
         if(param1 == null)
         {
            param1 = "";
      ...
      public function getRoomObjectImage(param1:int, param2:int, param3:int, param4:IVector3d, param5:int, param6:class_3158, param7:uint = 0) : class_3266
      {
            ...
            if((_loc16_ = _loc11_.getObject(param2,param3)) != null && _loc16_.getModel() != null)
            {
               ...
               switch(param3)
               {
                  ...
                  case 20:
                     ...
                     {
                        (_loc14_ = class_1588.getStuffDataWrapperForType(_loc8_)).initializeFromRoomObjectModel(_loc16_.getModel());
                        break;
                     }
                     break;
                  case 100:
      ...
      public function getGenericRoomObjectThumbnail(param1:String, param2:String, param3:class_3158, param4:String = null, param5:IStuffData = null) : class_3266
      {
         var _loc9_:* = undefined;
         var _loc13_:BitmapDataAsset = null;
         var _loc8_:BitmapData = null;
         var _loc7_:class_3266;
         (_loc7_ = new class_3266()).id = -1;
         if(!var_1981 || param1 == null)
         {
            return _loc7_;
         }
         var _loc6_:IRoomInstance;
         if((_loc6_ = _roomManager.getRoom("temporary_room")) == null)
         {
            if((_loc6_ = _roomManager.createRoom("temporary_room",null)) == null)
            {
               return _loc7_;
            }
         }
         var _loc11_:int = var_2361.reserveNumber();
         ...
         {
            if((_loc9_ = var_2459.getValue(_loc10_)) == null)
            {
               _loc9_ = new Vector.<class_3158>(0);
               var_2459.add(_loc10_,_loc9_);
               var_1434.loadThumbnailContent(_loc11_,param1,param2,null);
            }
            _loc9_.push(param3);
         }
         else
         {
            if((_loc13_ = assets.getAssetByName(_loc10_) as BitmapDataAsset) && !_loc13_.disposed)
            {
               _loc8_ = _loc13_.content as BitmapData;
               try
               {
                  if(_loc8_ != null && _loc8_ is BitmapData && _loc8_.width > 0 && _loc8_.height > 0)
                  {
                     _loc7_.data = _loc8_.clone();
                  }
                  else
                  {
            ...
            var_2361.freeNumber(_loc11_ - 1);
            _loc7_.id = 0;
         }
         return _loc7_;
      }
      
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:class_3158, param6:uint = 0, param7:String = null, param8:IStuffData = null, param9:int = -1, param10:int = -1, param11:String = null, param12:int = -1) : class_3266
      {
         var _loc18_:PetFigureData = null;
         var _loc23_:RoomObjectDataUpdateMessage = null;
         var _loc15_:int = 0;
         var _loc17_:class_3266;
         (_loc17_ = new class_3266()).id = -1;
         if(!var_1981 || param1 == null)
         {
            return _loc17_;
         }
         ...
         var _loc21_:int = var_2322.reserveNumber();
         ...
         {
            var_3151.add(String(_loc21_),param5);
            _loc13_.setNumber("image_query_scale",param4,true);
         }
         else
         {
            _loc16_.disposeObject(_loc21_,_loc22_);
            var_2322.freeNumber(_loc21_ - 1);
            _loc17_.id = 0;
         }
         _loc20_.dispose();
         return _loc17_;
      ...
      {
         return getRoomObjectBoundingRectangle(var_1467,-1,0,param1);
      }
      
      public function getActiveRoomActiveCanvas() : IRoomRenderingCanvas
      {
         return getRoomCanvas(var_1467,var_2194);
      }
      ...
      public function iconLoaded(param1:int, param2:String, param3:Boolean) : void
      {
         ...
         var_2361.freeNumber(param1 - 1);
         var _loc5_:Vector.<class_3158>;
         if((_loc5_ = var_2459.getValue(param2)) != null)
         {
            var_2459.remove(param2);
            _loc4_ = (_loc7_ = assets.getAssetByName(param2) as BitmapDataAsset).content as BitmapData;
      ...
      public function contentLoaded(param1:String, param2:Boolean) : void
      {
         ...
         var _loc13_:* = 0;
         var _loc12_:int = var_1434.getObjectCategory(param1);
         ...
         while(_loc6_ >= 0)
         {
            if((_loc14_ = _loc8_.getObjectWithIndex(_loc6_,_loc12_)) != null && _loc14_.getModel() != null && _loc14_.getType() == param1)
            {
               ...
               var_2322.freeNumber(_loc11_ - 1);
               if((_loc5_ = var_3151.remove(String(_loc11_)) as class_3158) != null)
               {
                  if(_loc9_ != null)
                  {
      ...
      public function objectInitialized(param1:String, param2:int, param3:int) : void
      {
         ...
         if((_loc9_ = getRoomObject(_loc8_,param2,param3) as IRoomObjectController) != null && _loc9_.getModel() != null && _loc9_.getEventHandler() != null)
         {
            if(!isNaN(_loc9_.getModel().getNumber("furniture_data_format")))
            {
               ...
               (_loc4_ = class_1588.getStuffDataWrapperForType(_loc5_)).initializeFromRoomObjectModel(_loc9_.getModel());
      ...
      public function selectAvatar(param1:int, param2:int) : void
      {
         if(var_1504 != null)
         {
            var_1504.setSelectedAvatar(param1,param2,true);
         }
      }
      ...
      public function getSelectedAvatarId() : int
      {
         if(var_1504 != null)
         {
            return var_1504.getSelectedAvatarId();
         }
         return -1;
      }
      ...
      public function selectRoomObject(param1:int, param2:int, param3:int) : void
      {
         ...
         var_1504.setSelectedObject(param1,param2,param3);
      }
      
      protected function addObjectToTileMap(param1:int, param2:IRoomObject) : void
      {
         var _loc3_:class_3280 = getRoomInstanceData(param1).tileObjectMap;
         if(_loc3_)
         {
      ...
      private function onRoomAdImageLoaded(param1:AdEvent) : void
      {
         ...
         {
            var_1434.addGraphicAsset(_loc4_.getType(),param1.imageUrl,param1.image,true);
         }
         switch(param1.type)
         {
      ...
      public function insertContentLibrary(param1:int, param2:int, param3:class_21) : Boolean
      {
         return var_1434.insertObjectContent(param1,param2,param3);
      }
      
      public function setActiveObjectType(param1:int, param2:String) : void
      {
         var_1434.setActiveObjectType(param1,param2);
      }
      ...
      public function requestBadgeImageAsset(param1:int, param2:int, param3:int, param4:String, param5:Boolean = true) : void
      {
         ...
         if(!(_loc7_ = (_loc8_ = param5 ? _sessionDataManager.getGroupBadgeAssetName : _sessionDataManager.getBadgeImageAssetName).call(null,param4)))
         {
            ...
            if(!var_1838)
            {
               var_1838 = new class_24();
            }
            if(false)
            {
               _sessionDataManager.events.addEventListener("BIRE_BADGE_IMAGE_READY",onBadgeLoaded);
            }
            if((_loc6_ = var_1838.getValue(param4)) == null)
            {
               _loc6_ = [];
            }
            _loc6_.push(new class_3240(_loc11_,param5));
            var_1838[param4] = _loc6_;
         }
         else
         {
      ...
      private function addBadgeGraphicAssets(param1:IRoomObjectController, param2:String, param3:Boolean = false) : void
      {
         ...
         var_1434.addGraphicAsset(param1.getType(),_loc7_,_loc4_,false);
         var _loc5_:String = _loc10_.call(null,param2);
         var _loc6_:BitmapData;
         if(_loc6_ = _loc8_.call(null,param2))
         {
            var_1434.addGraphicAsset(param1.getType(),_loc5_,_loc6_,false);
         }
      }
      ...
      {
         var _loc4_:int = 0;
         var _loc3_:class_3240 = null;
         var _loc5_:Function = null;
         var _loc6_:RoomObjectGroupBadgeUpdateMessage = null;
         var _loc2_:Array = var_1838.getValue(param1.badgeId) as Array;
         if(_loc2_ == null)
         {
         ...
         var_1838.remove(param1.badgeId);
         if(false)
         {
      ...
      public function get isDecorateMode() : Boolean
      {
         ...
         var _loc1_:IRoomSession = _roomSessionManager.getSession(var_1467);
      ...
      public function showUseProductSelection(param1:int, param2:int, param3:int = -1) : void
      {
         ...
         if(var_1434 != null)
         {
            _loc4_ = var_1434.getActiveObjectType(param2);
            _loc5_ = getRoomObjectCategory(_loc4_);
            events.dispatchEvent(new RoomEngineUseProductEvent("ROSM_USE_PRODUCT_FROM_INVENTORY",var_1467,param3,_loc5_,param1,param2));
         }
      }
      ...
      public function setAvatarEffect(param1:int) : void
      {
         ...
         var _loc2_:IRoomSession = _roomSessionManager.getSession(var_1467);
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function fixedUserLocation(param1:int, param2:IVector3d) : IVector3d
      {
         ...
         var _loc5_:class_3196 = getFurniStackingHeightMap(param1);
         var _loc7_:class_3155 = getLegacyGeometry(param1);
         ...
         if(Math.abs(_loc6_ - _loc3_) < 0.1 && Math.abs(_loc3_ - _loc4_) < 0.1)
         {
      ...
      public function getRenderRoomMessage(param1:Rectangle, param2:uint, param3:Boolean = false, param4:Boolean = true, param5:Boolean = false, param6:int = -1) : IMessageComposer
      {
         ...
         if(param6 > -1)
         {
            _loc8_ = getRoomCanvas(var_1467,param6);
         }
         else
         {
         ...
         var _loc12_:int = -1;
         if(!param4 && _roomSessionManager.getSession(var_1467) != null)
         {
            _loc12_ = _roomSessionManager.getSession(var_1467).ownUserRoomId;
         }
         var _loc11_:class_3267;
         var _loc10_:String = (_loc11_ = new class_3267()).getFurniData(param1,_loc8_,this,_loc12_);
         ...
         if(param3)
         {
            return new class_689(_loc7_,_loc10_,_loc9_,var_1467,_sessionDataManager.topSecurityLevel);
         }
         return new class_688(_loc7_,_loc10_,_loc9_,var_1467,_sessionDataManager.topSecurityLevel);
      }
      
      public function get roomContentLoader() : com.sulake.habbo.room.class_3161
      {
         return var_1434;
      }
   }
