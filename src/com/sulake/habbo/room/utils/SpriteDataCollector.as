package com.sulake.habbo.room.utils
{
   ...
   public class SpriteDataCollector
   {
      ...
      private static function addMannequinSprites(param1:Vector.<RoomObjectSpriteData>, param2:class_1680) : Vector.<RoomObjectSpriteData>
      {
      ...
      public function getFurniData(param1:Rectangle, param2:IRoomRenderingCanvas, param3:class_1680, param4:int) : String
      {
      ...
      public function getRoomRenderingModifiers(param1:class_1680) : String
      {
         var _loc2_:* = {};
         return JSON.stringify(_loc2_);
      }
      
      private function getSpriteDataObject(param1:RoomObjectSpriteData, param2:Rectangle, param3:IRoomRenderingCanvas, param4:class_1680) : Object
      {
      ...
      private function makeBackgroundPlane(param1:Rectangle, param2:uint, param3:Array) : class_1320
      {
         ...
         if(param3.length > 0)
         {
            ...
            if(var_2293)
            {
               _loc4_ = Math.max(var_2293,_loc4_);
            }
         }
         else
         {
            _loc4_ = !!var_2293 ? var_2293 : 0;
         }
         _loc4_ += spriteCount * 1.776104 + param3.length * 2.31743;
         var _loc5_:class_1320;
         (_loc5_ = new PlaneDrawingData(null,param2)).cornerPoints = _loc9_;
         _loc5_.z = _loc4_;
         return _loc5_;
      }
      
      private function sortRoomPlanes(param1:Vector.<IRoomPlane>, param2:IRoomRenderingCanvas, param3:class_1680) : Array
      {
         var _loc6_:* = null;
         var _loc7_:IRoomObjectSprite = null;
         var _loc9_:class_24 = new class_24();
      ...
      public function getRoomPlanes(param1:Rectangle, param2:IRoomRenderingCanvas, param3:class_1680, param4:uint) : Array
      {
         ...
         var _loc10_:* = [];
         var _loc7_:IPlaneVisualization;
         var _loc18_:IRoomObject;
         if(_loc7_ = (_loc18_ = param3.getRoomObject(param3.activeRoomId,-1,0)).getVisualization() as IPlaneVisualization)
         {
