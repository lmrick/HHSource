package com.sulake.habbo.room.object.logic
{
   ...
   public class AvatarLogic extends MovingObjectLogic
   {
      ...
      private static const const_718:Number = 1.5;
      
      private static const EFFECT_TYPE_SPLASH:int = 28;
      
      private static const EFFECT_TYPE_SWIM:int = 29;
      
      private static const const_1142:int = 184;
      
      private static const const_549:int = 185;
      ...
      private var var_3115:int = 0;
      
      public function AvatarLogic()
      {
         super();
         var_3266 = getTimer() + getBlinkInterval();
      }
      
      override public function getEventTypes() : Array
      {
         var _loc1_:* = ["ROE_MOUSE_CLICK","ROME_POSITION_CHANGED","ROE_MOUSE_ENTER","ROE_MOUSE_LEAVE","ROFCAE_MOUSE_BUTTON","ROFCAE_MOUSE_ARROW"];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(param1 is RoomObjectAvatarChatUpdateMessage)
         {
            ...
            var_3061 = getTimer() + _loc22_.numberOfWords * 1000;
            return;
         }
         ...
         if(param1 is RoomObjectAvatarExpressionUpdateMessage)
         {
            ...
            var_2226 = AvatarAction.getExpressionTime(_loc14_.getNumber("figure_expression"));
            if(var_2226 > -1)
            {
               var_2226 += getTimer();
            }
      ...
      private function updateActions(param1:int, param2:IRoomObjectModelController) : void
      {
         if(var_3061 > 0)
         {
            ...
            else if(var_2390 == 0 && var_2235 == 0)
            {
               var_2235 = param1 + getTalkingPauseInterval();
               var_2390 = var_2235 + getTalkingPauseLength();
            }
            else if(var_2235 > 0 && param1 > var_2235)
            {
               param2.setNumber("figure_talk",0);
               var_2235 = 0;
            }
            else if(var_2390 > 0 && param1 > var_2390)
            {
               param2.setNumber("figure_talk",1);
               var_2390 = 0;
            }
         }
         if(var_2226 > 0 && param1 > var_2226)
         {
         ...
         {
            if(param1 - var_2638 > 5000)
            {
               if((param1 - var_2638) % 10000 < 1000)
               {
         ...
         if(param1 > var_3266)
         {
            ...
            var_3266 = param1 + getBlinkInterval();
            var_3042 = param1 + getBlinkLength();
         }
         if(var_3042 > 0 && param1 > var_3042)
         {
            param2.setNumber("figure_blink",0);
            var_3042 = 0;
         }
         if(var_1706 > 0 && param1 > var_1706)
         {
            param2.setNumber("figure_effect",var_2005);
            var_1706 = 0;
         }
         if(var_3115 > 0 && param1 > var_3115)
         {
