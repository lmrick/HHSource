package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneVisualizationLayer implements class_13
   {
      ...
      private var var_2593:com.sulake.habbo.room.object.visualization.room.rasterizer.basic.PlaneMaterial = null;
      ...
      public function PlaneVisualizationLayer(param1:com.sulake.habbo.room.object.visualization.room.rasterizer.basic.PlaneMaterial, param2:uint, param3:int, param4:int = 0)
      {
         super();
         var_2593 = param1;
         _offset = param4;
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:int) : BitmapData
      {
         ...
         if(var_2593 != null)
         {
            if(_loc11_)
            {
               _loc15_ = var_2593.render(null,param2,param3,param4,param5,param6,param7 + offset,align == 1);
            }
            else
            {
               _loc15_ = var_2593.render(param1,param2,param3,param4,param5,param6,param7 + offset,align == 1);
            }
      ...
      public function getMaterial() : com.sulake.habbo.room.object.visualization.room.rasterizer.basic.PlaneMaterial
      {
         return var_2593;
      }
