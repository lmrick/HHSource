package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneVisualization
   {
      ...
      public function setLayer(param1:int, param2:PlaneMaterial, param3:uint, param4:int, param5:int = 0) : Boolean
      {
         ...
         var _loc6_:*;
         if((_loc6_ = _layers[param1] as class_13) != null)
         {
            _loc6_.dispose();
            _loc6_ = null;
         }
      ...
      public function setAnimationLayer(param1:int, param2:XML, param3:IGraphicAssetCollection) : Boolean
      {
         ...
         var _loc4_:*;
         if((_loc4_ = _layers[param1] as class_13) != null)
         {
            _loc4_.dispose();
            _loc4_ = null;
         }
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int = 0, param7:int = 0, param8:int = 0, param9:int = 0, param10:Number = 0, param11:Number = 0, param12:int = 0) : BitmapData
      {
            ...
            try
            {
               if(var_1456.width == param2 && var_1456.height == param3 && Vector3d.isEqual(_cachedBitmapNormal,param4))
               {
                  if(!hasAnimationLayers)
                  {
                     if(param1 != null)
                     {
                        param1.copyPixels(var_1456,var_1456.rect,new Point(0,0),null,null,false);
                        return param1;
                     }
                     return var_1456;
                  }
         ...
         if(param1 != null && param1 != var_1456)
         {
            var_1456.copyPixels(param1,param1.rect,new Point(0,0),null,null,false);
            return param1;
         }
         return var_1456;
      }
