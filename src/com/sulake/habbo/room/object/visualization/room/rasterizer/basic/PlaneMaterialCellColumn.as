   ...
   public class PlaneMaterialCellColumn
   {
      ...
      public function render(param1:int, param2:IVector3d, param3:int, param4:int) : BitmapData
      {
         ...
         if(isStatic)
         {
            if(var_1456 != null)
            {
               if(var_1456.height == param1 && Vector3d.isEqual(_cachedBitmapNormal,param2) && var_4194 == param3 && var_3957 == param4)
               {
                  return var_1456;
               }
               var_1456.dispose();
         ...
         if(var_1456 == null)
         {
            try
            {
               var_1456 = new BitmapData(_width,param1,true,16777215);
            }
            catch(e:Error)
            {
               return null;
      ...
      {
         var _loc8_:int = 0;
         if(param1 == null || param1.length == 0 || var_1456 == null)
         {
            return param2;
         }
         ...
         while(_loc8_ < param1.length)
         {
            ...
            if(_loc9_ != null)
            {
               if((_loc7_ = _loc9_.render(param4,param5,param6)) != null)
               {
                  ...
                  var_1456.copyPixels(_loc7_,_loc7_.rect,new Point(0,param2),_loc7_,null,true);
                  if(param3)
                  {
                     param2 += _loc7_.height;
                  }
                  if(param3 && param2 >= var_1456.height || !param3 && param2 <= 0)
                  {
                     return param2;
                  }
               }
      ...
      private function renderRepeatAll(param1:IVector3d, param2:int, param3:int) : void
      {
         ...
         var _loc4_:int = 0;
         if(_loc5_ > var_1456.height)
         {
         }
         while(_loc4_ < var_1456.height)
         {
      ...
      private function renderRepeatBorders(param1:IVector3d) : void
      {
         ...
         if((_loc8_ = _cells[-1] as PlaneMaterialCell) != null)
         {
            _loc3_ = [_loc8_];
            while(_loc7_ < var_1456.height)
            {
      ...
      private function renderRepeatCenter(param1:IVector3d) : void
      {
         ...
         var _loc2_:int = 0;
         var _loc15_:int = 0;
         if(_loc10_ + _loc12_ > var_1456.height)
         {
            _loc13_ = _loc10_ + _loc12_ - 0;
            _loc2_ -= _loc13_ >> 1;
            _loc15_ += _loc13_ - (_loc13_ >> 1);
         }
         if(_loc13_ == 0)
         {
            if((_loc5_ = _cells[0] as PlaneMaterialCell) != null)
            {
               if((_loc16_ = _loc5_.getHeight(param1)) > 0)
               {
                  _loc7_ = 0 - (_loc10_ + _loc12_);
      ...
      private function renderRepeatLast(param1:IVector3d) : void
      {
         ...
         if((_loc4_ = _cells[-1] as PlaneMaterialCell) != null)
         {
            _loc2_ = [_loc4_];
            while(_loc3_ < var_1456.height)
            {
