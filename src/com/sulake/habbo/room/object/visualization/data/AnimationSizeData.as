package com.sulake.habbo.room.object.visualization.data
{
   ...
   public class AnimationSizeData extends SizeData
   {
      ...
      private var var_1830:class_24 = null;
      
      private var var_3215:Array;
      
      public function AnimationSizeData(param1:int, param2:int)
      {
         var_3215 = [];
         super(param1,param2);
         var_1830 = new class_24();
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_1830.length)
            {
               _loc2_ = var_1830.getWithIndex(_loc1_) as AnimationData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function defineAnimations(param1:XML) : Boolean
      {
         ...
         while(_loc6_ < _loc9_.length())
         {
            ...
            if(!class_1667.checkRequiredAttributes(_loc10_,_loc7_))
            {
               return false;
            }
            ...
            var_1830.add(_loc14_,_loc2_);
            if(!_loc13_)
            {
               var_3215.push(_loc14_);
            }
            _loc6_++;
         }
         return true;
      ...
      {
         if(var_1830.getValue(param1) != null)
         {
            return true;
         }
         return false;
      ...
      {
         var _loc3_:AnimationData = var_1830.getValue(param1) as AnimationData;
         if(_loc3_ != null)
         {
      ...
      public function getFrame(param1:int, param2:int, param3:int, param4:int) : AnimationFrame
      {
         ...
         if((_loc5_ = var_1830.getValue(param1) as AnimationData) != null)
         {
      ...
      public function getFrameFromSequence(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : AnimationFrame
      {
         ...
         if((_loc7_ = var_1830.getValue(param1) as AnimationData) != null)
         {
