package com.sulake.habbo.room.object.visualization.data
{
   public class DirectionData
   {
      ...
      {
         var _loc2_:int = 0;
         var _loc3_:class_3395 = null;
         _layers = [];
         super();
         _loc2_ = 0;
         while(_loc2_ < param1)
         {
            _loc3_ = new class_3395();
            _layers.push(_loc3_);
            _loc2_++;
         }
      }
      ...
      private function getLayer(param1:int) : class_3395
      {
      ...
      {
         var _loc2_:class_3395 = getLayer(param1);
         if(_loc2_ != null)
         {
            return _loc2_.tag;
         }
      ...
      {
         var _loc3_:class_3395 = getLayer(param1);
         if(_loc3_ != null)
         {
            _loc3_.tag = param2;
         }
      ...
      public function copyValues(param1:DirectionData) : void
      {
         ...
         var _loc4_:class_3395 = null;
         var _loc2_:class_3395 = null;
         _loc3_ = 0;
