package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureRoomBrandingVisualization extends FurnitureVisualization
   {
      ...
      private static const const_1171:int = 2;
      
      private static const const_540:int = 3;
       
      
      protected var var_350:String;
      
      protected var var_2700:Boolean = false;
      
      protected var var_3399:int;
      
      protected var var_3413:int;
      
      protected var var_3576:int;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc4_ = super.updateModel(param1))
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  var_3399 = _loc3_.getNumber("furniture_branding_offset_x");
                  var_3413 = _loc3_.getNumber("furniture_branding_offset_y");
                  var_3576 = _loc3_.getNumber("furniture_branding_offset_z");
               }
            }
         }
         if(!var_2700)
         {
            var_2700 = checkIfImageReady();
            if(var_2700)
            {
               checkAndCreateImageForCurrentState(param1);
               return true;
      ...
      protected function checkIfImageReady() : Boolean
      {
         ...
         if(_loc1_ != null)
         {
            if((_loc4_ = _loc1_.getModel()) != null)
            {
               ...
               if(_loc3_ != null)
               {
                  if(var_350 == null || var_350 != _loc3_)
                  {
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(var_350 != null && _loc3_ == "branded_image")
         {
            return var_350 + "_" + _loc4_ + "_" + object.getState(0);
         }
         return _loc5_;
      }
      ...
      private function checkAndCreateImageForCurrentState(param1:int) : void
      {
         ...
         if(object == null || var_350 == null)
         {
            return;
         }
         var _loc11_:IGraphicAsset;
         if((_loc11_ = assetCollection.getAsset(var_350)) == null)
         {
            return;
         }
         var _loc14_:int = object.getState(0);
         var _loc9_:int = getSize(param1);
         var _loc12_:String = var_350 + "_" + _loc9_ + "_" + _loc14_;
         ...
         if(var_350.indexOf("noscale") > -1)
         {
            _loc4_ = false;
         }
         if(var_350.indexOf("force32") > -1)
         {
            _loc9_ = 32;
         }
         if(_loc9_ == 32 && _loc4_)
