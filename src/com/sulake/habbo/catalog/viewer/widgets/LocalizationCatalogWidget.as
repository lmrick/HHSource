package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class LocalizationCatalogWidget extends CatalogWidget implements class_3321
   {
      ...
      public function LocalizationCatalogWidget(param1:class_3151, param2:HabboCatalog)
      {
         super(param1);
         var_2545 = new Dictionary();
         _catalog = param2;
      }
      ...
      {
         var _loc4_:class_18 = (page.viewer.catalog as HabboCatalog).localization;
         var _loc2_:class_19 = page.viewer.catalog as HabboCatalog;
         var _loc6_:String = String(class_3127(param1.target).name);
         var _loc5_:String = "";
         loop0:
         switch(page.layoutCode)
         {
            case "frontpage3":
               ...
               {
                  case "ctlg_txt3":
                     if(class_3127(param1.target).caption != "")
                     {
      ...
      private function initStaticImages() : void
      {
         ...
         {
            if(_loc3_ is class_3282)
            {
               _loc4_ = _loc3_.name;
               _loc2_ = _loc3_.name;
               var_2545[_loc2_] = _loc4_;
      ...
      protected function initLocalizables() : void
      {
         ...
         while(_loc4_ < page.localization.textCount)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc8_ is class_3181)
               {
                  _loc8_.addEventListener("WE_LINK",onClickHtmlLink);
                  setLinkStyle(_loc8_ as class_3181);
               }
            }
            else
            {
         ...
         var _loc1_:class_3188 = _catalog.currentCatalogNavigator.getNodeById(page.pageId);
         var _loc7_:class_3127 = _catalog.mainContainer.findChildByName("catalog.header.title");
         ...
         {
            _loc3_.assetUri = page.mode == 1 ? "common_small_pen" : (_catalog.catalogType == "BUILDERS_CLUB" ? "undefinedicon_193.png" : _catalog.imageGalleryHost + _loc1_.iconName + ".png");
         }
      }
      
      private function onClickHtmlLink(param1:class_3134) : void
      {
      ...
      private function setElementImage(param1:String, param2:String) : void
      {
         ...
         if(_loc9_ is class_3282)
         {
            ...
            if((_loc9_ as class_3282).bitmap == null)
            {
               (_loc9_ as class_3282).bitmap = new BitmapData(_loc9_.width,_loc9_.height,true,16777215);
            }
            (_loc9_ as class_3282).bitmap.fillRect((_loc9_ as class_3282).bitmap.rect,16777215);
            _loc3_ = (_loc9_.width - _loc4_.width) / 2;
            _loc5_ = (_loc9_.height - _loc4_.height) / 2;
            (_loc9_ as class_3282).bitmap.copyPixels(_loc4_,_loc4_.rect,new Point(_loc3_,_loc5_),null,null,true);
         }
      ...
      private function retrieveCatalogImage(param1:String) : void
      {
         ...
         var _loc8_:String;
         if((_loc8_ = "null") == "catalog.header.image")
         {
