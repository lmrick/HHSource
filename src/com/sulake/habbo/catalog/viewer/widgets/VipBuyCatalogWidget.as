package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class VipBuyCatalogWidget extends CatalogWidget implements class_3321, IVipBuyCatalogWidget
   {
      ...
      public function VipBuyCatalogWidget(param1:class_3151, param2:HabboCatalog, param3:Boolean = false)
      {
         super(param1);
         _catalog = param2;
         var_3036 = param3;
      ...
      override public function init() : Boolean
      {
         ...
         _offers = [];
         var_282 = _catalog.getClubBuyController();
         var_282.registerVisualization(this);
         var_282.requestOffers(var_3036 ? 2 : 1);
         return true;
      }
      ...
      public function initClubType(param1:int) : void
      {
         ...
         var _loc2_:class_18 = _catalog.localization;
         var _loc6_:class_3160;
         ...
         if(_window != null && param1 == 2 && !var_3036)
         {
      ...
      private function initLinks() : void
      {
         ...
         if(_window)
         {
            ...
            if(_loc1_ && var_282)
            {
               _loc1_.text = var_282.localization.getLocalization("catalog.vip.buy.hccenter","catalog.vip.buy.hccenter");
               setLinkStyle(_loc1_);
            }
         }
      }
      ...
      public function showOffer(param1:ClubBuyOfferData) : void
      {
         ...
         try
         {
            _loc2_ = new VipBuyItem(param1,_catalog,var_3036 ? "HabboCatalogGift" : "HabboCatalogBuy");
         }
         catch(e:Error)
         {
