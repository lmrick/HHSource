package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceOwnItemsCatalogWidget extends CatalogWidget implements class_3321, class_3158, IMarketPlaceVisualization
   {
      ...
      private var var_3152:class_24;
      
      private var _itemList:IItemListWindow;
      
      private var _offers:class_24;
      
      public function MarketPlaceOwnItemsCatalogWidget(param1:class_3151)
      {
         super(param1);
         var_3152 = new class_24();
      }
      ...
      override public function init() : Boolean
      {
         ...
         var _loc2_:class_1684 = marketPlace.windowManager;
         if(_loc2_ == null)
         {
            return false;
         }
         ...
         var_3152.add(1,_loc1_.removeListItem(_loc1_.getListItemByName("ongoing_item")));
         var_3152.add(2,_loc1_.removeListItem(_loc1_.getListItemByName("sold_item")));
         var_3152.add(3,_loc1_.removeListItem(_loc1_.getListItemByName("expired_item")));
      ...
      private function showRedeemInfo(param1:Boolean) : void
      {
         ...
         var _loc2_:class_3151 = window.findChildByName("redeem_border") as class_3151;
         if(_loc2_)
         {
      ...
      private function updateList(param1:class_24) : void
      {
         ...
         var _loc16_:class_3127 = null;
         var _loc6_:class_3266 = null;
         var _loc23_:class_3282 = null;
         var _loc9_:Point = null;
         var _loc28_:class_3127 = null;
         var _loc19_:class_3217 = null;
         var _loc27_:ILimitedItemGridOverlayWidget = null;
         var _loc25_:class_3217 = null;
         ...
         while(_loc21_ < _loc5_.length)
         {
            ...
            if(_loc24_ = var_3152.getValue(_loc17_.status))
            {
               if(!(!(_loc4_ = _loc24_.clone() as class_3151) || Boolean(_loc4_.disposed)))
               {
                  ...
                  if(_loc17_.image != null)
                  {
                     if((_loc23_ = _loc4_.findChildByName("item_image") as class_3282) != null)
                     {
                  ...
                  if(_loc17_.isUniqueLimitedItem)
                  {
                     ...
                     _loc19_ = class_3217(_loc4_.findChildByName("unique_item_overlay_widget"));
                  ...
                  {
                     _loc25_ = class_3217(_loc4_.findChildByName("rarity_item_overlay_widget"));
      ...
      private function onGridEvent(param1:class_3134, param2:class_3127 = null) : void
      {
      ...
      private function onWidgetEvent(param1:class_3134, param2:class_3127) : void
      {
         if(param2 == null)
         {
