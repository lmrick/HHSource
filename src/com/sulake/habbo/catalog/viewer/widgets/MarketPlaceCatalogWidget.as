package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements class_3321, class_3158, IMarketPlaceVisualization
   {
      ...
      private var var_2687:MarketPlaceOfferData;
      
      private var _itemList:IItemListWindow;
      
      private var var_2295:class_3151;
      ...
      public function MarketPlaceCatalogWidget(param1:class_3151)
      {
         var_2044 = [];
         super(param1);
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_2102)
         {
            var_2102.removeEventListener("timer",onPopulationTimer);
            var_2102 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         var_2295 = _loc1_.removeListItem(_loc1_.getListItemByName("offer_item")) as class_3151;
         return true;
      }
      ...
      public function updateStats() : void
      {
         ...
         var _loc2_:class_3227 = marketPlace.itemStats;
         if(!_loc2_)
         {
            return;
         }
         var _loc5_:class_3151;
         if(!(_loc5_ = _window.findChildByName("details_container") as class_3151) || !_loc5_.visible)
         {
            return;
         }
         ...
         if(_loc7_ = _loc5_.findChildByName("chart_bitmap") as class_3282)
         {
            _loc7_.bitmap = null;
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         var _loc3_:class_3151 = _window.findChildByName("search_container") as class_3151;
         if(_loc3_ == null)
         {
            return;
         }
         ...
         switch(param1)
         {
            ...
            case "search_advanced":
               ...
               var_2044 = [1,2,3,4,5,6];
               break;
            default:
               return;
         }
         var _loc7_:class_3151 = createWindow(_loc5_) as class_3151;
         _loc3_.addChild(_loc7_);
         var _loc6_:class_3287;
         if((_loc6_ = _window.findChildByName("sort_dropmenu") as class_3287) != null)
         {
            _loc6_.populate(getSortKeys(var_2044));
            _loc6_.selection = 0;
         }
      }
      ...
      private function updateList() : void
      {
         ...
         var _loc1_:class_24 = marketPlace.latestOffers();
         if(!_loc1_)
         {
            return;
         }
         ...
         if(!var_2102)
         {
            var_2102 = new Timer(25);
            var_2102.addEventListener("timer",onPopulationTimer);
         }
         var_2819 = 0;
         populateList();
         var_2102.start();
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_2819 >= _offers.length)
            {
               return true;
            }
            addListItem(_offers.getWithIndex(var_2819));
            var_2819++;
            _loc1_++;
         }
         return false;
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         if(!param1 || !_itemList || !var_2295 || true)
         {
            return;
         }
         var _loc14_:class_3151;
         if(!(_loc14_ = var_2295.clone() as class_3151) || Boolean(_loc14_.disposed))
         {
            return;
         }
         ...
         if(param1.image != null)
         {
            if((_loc5_ = _loc14_.findChildByName("item_image") as class_3282) != null)
            {
         ...
         if(param1.isUniqueLimitedItem)
         {
            ...
            _loc3_ = class_3217(_loc14_.findChildByName("unique_item_overlay_widget"));
         ...
         {
            _loc7_ = class_3217(_loc14_.findChildByName("rarity_item_overlay_widget"));
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(_itemList.groupListItemsWithID(param1,_loc4_))
         {
            for each(_loc5_ in _loc4_)
            {
               if(_loc5_)
               {
                  if((_loc7_ = _loc5_.findChildByName("item_image") as class_3282) != null)
                  {
      ...
      private function getFurniImageResult(param1:int, param2:int, param3:String = null) : class_3266
      {
      ...
      private function onOfferListEvent(param1:class_3134, param2:class_3127 = null) : void
      {
         var _loc5_:int = 0;
      ...
      private function showDetails(param1:MarketPlaceOfferData) : void
      {
         ...
         var_2687 = param1;
         var _loc2_:class_18 = marketPlace.localization;
         if(!_loc2_)
         {
            return;
         }
         _window.getChildAt(0).visible = false;
         var _loc12_:class_3151;
         if(_loc12_ = _window.findChildByName("details_container") as class_3151)
         {
            _loc12_.visible = true;
         }
         else
         {
            _loc12_ = createWindow("marketplace_offer_details") as class_3151;
         ...
         if(param1.image != null)
         {
            if((_loc7_ = _loc12_.findChildByName("item_image") as class_3282) != null)
            {
               _loc7_.bitmap = null;
         ...
         var _loc14_:class_3282;
         if(_loc14_ = _loc12_.findChildByName("chart_bitmap") as class_3282)
         {
            _loc14_.bitmap = null;
         }
         var _loc5_:class_3217 = class_3217(_loc12_.findChildByName("unique_item_overlay_widget"));
         if(param1.isUniqueLimitedItem)
         {
         ...
         var _loc9_:class_3217 = class_3217(_loc12_.findChildByName("rarity_item_overlay_widget"));
         if(param1.stuffData && param1.stuffData.rarityLevel >= 0)
         {
      ...
      private function hideDetails() : void
      {
         ...
         var_2687 = null;
         var _loc1_:class_3127 = _window.findChildByName("details_container");
         if(_loc1_)
         {
      ...
      private function doSearch() : void
      {
         ...
         if((_loc5_ = _window.findChildByName("sort_dropmenu") as class_3287) && _loc5_.selection >= 0 && _loc5_.selection < var_2044.length)
         {
            _loc3_ = 0;
         }
      ...
      private function onWidgetEvent(param1:class_3134, param2:class_3127 = null) : void
      {
         ...
         var _loc3_:class_18 = marketPlace.localization;
         var _loc4_:class_3127 = window.findChildByName("search_input");
      ...
      private function detailsEventHandler(param1:class_3134, param2:class_3127) : void
      {
         if(!param1 || !param2)
         {
            return;
         ...
         if(param1.type == "WME_CLICK")
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_2687.offerId);
            }
            return;
         }
         if(param1.type == "WE_SELECTED")
