package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      public function draw(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc6_:int = Math.pow(10,var_2011.toString().length - 1);
         var_2011 = Math.ceil(var_2011 / _loc6_) * _loc6_;
         ...
         _loc9_.text = var_2011.toString();
         _loc8_.draw(_loc9_);
         _chartWidth = param1 - _loc9_.textWidth - 2;
         var_2838 = param2 - _loc9_.textHeight;
         ...
         _loc3_.graphics.lineTo(0,var_2838);
         _loc7_ = 0;
         while(_loc7_ <= 5)
         {
            _loc5_ = (var_2838 - 1) / 5 * _loc7_;
         ...
         _loc7_ = 1;
         while(_loc7_ < var_29.length)
         {
            _loc3_.graphics.lineTo(getX(_loc7_),getY(_loc7_));
            _loc7_++;
         }
         _loc8_.draw(_loc3_,new Matrix(1,0,0,1,param1 - _chartWidth,(param2 - var_2838) / 2));
         return _loc8_;
      }
      
      private function getX(param1:int) : Number
      {
         return _chartWidth + _chartWidth / -_xMin * 0;
      }
      
      private function getY(param1:int) : Number
      {
         return var_2838 - var_2838 / var_2011 * 0;
      }
      
      public function get available() : Boolean
      {
         return var_29 && var_28 && false;
      }
   }
}
