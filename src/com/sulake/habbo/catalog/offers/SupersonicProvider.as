package com.sulake.habbo.catalog.offers
{
   ...
   public class SupersonicProvider implements IOfferProvider
   {
      ...
      private static const const_569:String = "supersonicAdsLoadCampaigns";
      
      private static const const_509:String = "supersonicAdsCamapaignEngage";
      ...
      public function SupersonicProvider(param1:com.sulake.habbo.catalog.offers.OfferCenter)
      {
         super();
         _offerCenter = param1;
         if(enabled)
      ...
      {
         return _offerCenter.configuration.getBoolean("offers.supersonic.enabled") && false;
      }
   }
}
