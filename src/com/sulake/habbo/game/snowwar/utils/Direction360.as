package com.sulake.habbo.game.snowwar.utils
{
   ...
   public class Direction360 implements class_13
   {
      
      private static const const_1168:Number = 1;
      ...
      {
         return Direction8.getDirection8(Direction8.validateDirection8Value(class_3464.javaDiv(validateDirection360Value(param1 - 22) / 45) + 1));
      }
      ...
      {
         var_1758 = validateDirection360Value(param1);
      }
      
      public function rotateDirection(param1:int) : void
      {
         var_1758 += param1;
         var_1758 = validateDirection360Value(var_1758);
      }
      ...
      {
         return direction360ValueToDirection8(var_1758);
      }
      
      public function getBaseVectorXComponent() : int
      {
         return var_2960[0][var_1758];
      }
      
      public function getBaseVectorYComponent() : int
      {
         return var_2960[1][var_1758];
      }
   }
}
