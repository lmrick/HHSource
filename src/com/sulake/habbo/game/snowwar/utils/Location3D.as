package com.sulake.habbo.game.snowwar.utils
{
   ...
   public class Location3D implements class_13
   {
      ...
      {
         var _loc2_:int = param1.var_29 - var_29;
      ...
      {
         if(param1.var_29 == var_29 && param1.var_28 == var_28)
         {
            return null;
         }
         var _loc3_:int = param1.var_29 - var_29;
      ...
      public function hashCode() : int
      {
         ...
         return int(29 * _loc1_ + var_30);
      }
      
      public function toString() : String
      {
         return "_x:" + var_29 + "yy:" + var_28 + "_zz:" + var_30;
      }
      
      public function isInDistance(param1:Location3D, param2:int) : Boolean
      {
         return isInDistanceStatic(var_29,var_28,param1.var_29,param1.var_28,param2);
      }
   }
}
