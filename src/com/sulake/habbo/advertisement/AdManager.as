package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends class_20 implements class_1694
   {
      ...
      private var var_3160:BitmapData = null;
      
      private var var_2991:BitmapData = null;
      
      private var _billboardImageLoaders:class_24;
      
      private var var_3304:IMessageEvent;
      
      public function AdManager(param1:class_31, param2:uint = 0, param3:class_21 = null)
      {
      ...
      override protected function initComponent() : void
      {
         ...
         _billboardImageLoaders = new class_24();
         var_3304 = _communicationManager.addHabboConnectionMessageEvent(new class_968(onInterstitial));
         var _loc6_:String;
      ...
      override public function dispose() : void
      {
         ...
         {
            _communicationManager.removeHabboConnectionMessageEvent(var_3304);
            var_3304 = null;
         }
         if(var_3160)
         {
      ...
      public function showInterstitial() : void
      {
         ...
         _communicationManager.connection.send(new class_664());
      }
      
      private function onInterstitial(param1:class_968) : void
      {
         var _loc2_:class_1393 = param1.getParser();
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            var_3160 = emulateBackgroundTransparency(_loc2_.bitmapData);
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            var_2991 = emulateBackgroundTransparency(_loc2_.bitmapData);
         }
      }
