package com.sulake.habbo.session.furniture
{
   ...
   public class FurnitureDataParser extends EventDispatcherWrapper
   {
      ...
      private var var_2916:class_24;
      
      private var _localization:class_17;
      
      private var var_2704:AssetLibrary;
      
      public function FurnitureDataParser(param1:class_24, param2:class_24, param3:class_24, param4:class_17)
      {
         super();
         _floorItems = param1;
         _wallItems = param2;
         ...
         var_2704 = new AssetLibrary("FurniDataParserAssetLib");
      }
      ...
      public function loadData(param1:String, param2:String = null, param3:String = null) : void
      {
         var _loc4_:AssetLoaderStruct;
         (_loc4_ = var_2704.loadAssetFromFile("furnidata",new URLRequest(param1),"text/plain")).addEventListener("AssetLoaderEventComplete",parseFurnitureData);
         _loc4_.addEventListener("AssetLoaderEventError",furnitureDataError);
      }
      ...
      private function parseXmlFormat(param1:String) : void
      {
         ...
         {
            class_79.error("XML furni data was malformed: " + param1,true,12);
         }
         if(_loc5_ == null)
         {
            return;
      ...
      private function storeItem(param1:FurnitureData) : void
      {
         ...
         var _loc2_:* = var_2916[param1.className];
         if(_loc2_ == null)
         {
            _loc2_ = [];
            var_2916.add(param1.className,_loc2_);
         }
      ...
      private function furnitureDataError(param1:AssetLoaderEvent) : void
      {
         ...
         class_79.error("Could not download furnidata definition",true,12);
      }
