package com.sulake.habbo.ui.widget.furniture.contextmenu
{
   ...
   public class MonsterPlantSeedContextMenuView extends FurnitureContextInfoView
   {
      ...
      public function MonsterPlantSeedContextMenuView(param1:class_3167)
      {
         super(param1);
      }
      ...
      override protected function updateWindow() : void
      {
         ...
         else
         {
            if(!_window)
            {
               _loc1_ = XmlAsset(var_1429.assets.getAssetByName("monsterplant_seed_menu")).content as XML;
         ...
         if(param1.type == "WME_CLICK")
         {
            if(param2.name == "button")
            {
               ...
               if("use" === _loc5_)
               {
                  ...
                  {
                     _loc4_.showPlantSeedConfirmationDialog(var_1795);
                  }
               }
            }
            _loc3_ = true;
