package com.sulake.habbo.ui.widget.furniture.mysterybox
{
   ...
   public class MysteryBoxToolbarExtension implements class_13
   {
      
      private static const const_623:String = "mystery_box_toolbar_extension_minimised";
      ...
      private var var_1453:FurnitureContextMenuWidgetHandler;
      ...
      {
         var _loc1_:XML = var_1453.widget.assets.getAssetByName("mystery_box_toolbar_extension").content as XML;
         _window = var_1453.container.windowManager.buildFromXML(_loc1_) as class_3151;
         _window.findChildByName("faq_link").visible = var_1453.container.config.getProperty("mysterybox.faq.url") != "";
         _window.procedure = windowProcedure;
         var_1453.container.toolbar.extensionView.attachExtension("mystery_box",_window);
         var _loc2_:ISessionDataManager = var_1453.container.sessionDataManager;
      ...
      private function windowProcedure(param1:class_3134, param2:class_3127) : void
      {
         ...
         switch(param1.target.name)
         {
            ...
            case "maximize_region":
               ...
               break;
            case "faq_link":
               HabboWebTools.openWebPage(var_1453.container.config.getProperty("mysterybox.faq.url"),"habboMain");
         }
      }
      ...
      {
         return var_1453 != null && Boolean(var_1453.container.config.getBoolean("mystery_box_toolbar_extension_minimised"));
      }
      
      private function setMinimised(param1:Boolean) : void
      {
         if(var_1453 != null && _window != null)
         {
            if(param1)
            {
            ...
            var_1453.container.config.setProperty("mystery_box_toolbar_extension_minimised",param1.toString());
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(var_1453 != null)
         {
            var_1453.container.toolbar.extensionView.detachExtension("mystery_box");
            var_1453.container.sessionDataManager.events.removeEventListener("mbke_update",onKeysUpdated);
            var_1453 = null;
         }
         _disposed = true;
      }
