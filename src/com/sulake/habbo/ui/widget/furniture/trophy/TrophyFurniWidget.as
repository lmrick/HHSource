package com.sulake.habbo.ui.widget.furniture.trophy
{
   ...
   public class TrophyFurniWidget extends RoomWidgetBase implements ITrophyFurniWidget
   {
      ...
      public function TrophyFurniWidget(param1:IRoomWidgetHandler, param2:class_1684, param3:class_21, param4:class_18, param5:class_19)
      {
      ...
      private function updateInterface() : void
      {
         ...
         switch(var_3592 - 10)
         {
            case 0:
            case 10:
               var_1430 = new NikoTrophyView(this,var_3592);
               break;
            default:
