package com.sulake.habbo.ui.widget
{
   ...
   public class RoomWidgetFactory implements IRoomWidgetFactory
   {
      ...
      {
         if(_roomUI == null || true)
         {
            return null;
         }
         var _loc3_:class_21 = _roomUI.assets;
         var _loc4_:class_1684 = _roomUI.windowManager;
         switch(param1)
         {
            case "RWE_CHAT_WIDGET":
               return new RoomChatWidget(param2,_loc4_,_loc3_,_roomUI.localization,_roomUI,var_3743++,_roomUI);
