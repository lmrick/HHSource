package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends class_20 implements IRoomUI, class_41
   {
      ...
      private var var_2635:com.sulake.habbo.ui.IRoomWidgetFactory;
      ...
      private var _habboGroupsManager:class_1752;
      
      private var _avatarEditor:class_1753;
      
      private var _catalog:IHabboCatalog;
      
      private var _adManager:class_1694;
      ...
      private var _friendBarView:class_3203;
      ...
      private var var_1637:class_24;
      
      private var var_3474:int = -1;
      ...
      public function RoomUI(param1:class_31, param2:uint = 0, param3:class_21 = null)
      {
         super(param1,param2,param3);
         var_2635 = new RoomWidgetFactory(this);
         var_1637 = new class_24();
      ...
      override protected function get dependencies() : Vector.<ComponentDependency>
      {
         ...
         }),new ComponentDependency(new IIDHabboGroupsManager(),function(param1:class_1752):void
         {
         ...
         {
            _friendBar = param1;
         }),new ComponentDependency(new IIDHabboFriendBarView(),function(param1:class_3203):void
         {
         ...
         {
            _messenger = param1;
         }),new ComponentDependency(new IIDHabboFreeFlowChat(),function(param1:class_1692):void
         {
      ...
      {
         _perkAllowancesMessageEvent = _communication.addHabboConnectionMessageEvent(new class_782(onPerkAllowances));
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_1637 != null)
         {
            while(false)
            {
               _loc2_ = var_1637.getKey(0) as String;
               _loc1_ = var_1637.remove(_loc2_) as RoomDesktop;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
         ...
         switch(param1.type)
         {
            ...
            case "RSE_ENDED":
               if(param1.session != null)
               {
                  ...
                  {
                     if(getBoolean("nux.lobbies.enabled") && false)
                     {
                        if(false && _navigator.enteredGuestRoomData.doorMode == 4)
                        {
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         _windowManager.alert(errorTitle,errorMessage,0,function(param1:class_3132, param2:class_3134):void
         {
            param1.dispose();
         });
      }
      ...
      {
         var _loc2_:String = getRoomIdentifier(var_3157);
      ...
      private function interstitialCompleteEventHandler(param1:InterstitialEvent) : void
      {
         ...
         {
            _communication.connection.send(new class_165());
         }
         var _loc2_:String = getRoomIdentifier(var_3157);
         var _loc3_:RoomDesktop = getDesktop(_loc2_) as RoomDesktop;
         if(_loc3_ != null)
      ...
      private function onPerkAllowances(param1:class_782) : void
      {
         ...
         if(_freeFlowChat && _isInRoom && !var_3225)
         {
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         if(param1.roomId == var_3157)
         {
            if(param1.type == "REE_OBJECTS_INITIALIZED")
            {
               if(var_1741 == true)
               {
                  if((_loc4_ = _roomSessionManager.getSession(var_3157)) != null)
                  {
                     _loc4_.sendAvatarExpressionMessage(AvatarExpressionEnum.const_419.ordinal);
                  }
               }
               var_1741 = false;
            }
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case "REE_INITIALIZED":
               ...
               if(var_3474 != -1)
               {
                  _loc4_.initializeWidget("RWE_USER_CHOOSER",var_3474);
               }
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc2_.roomWidgetFactory = var_2635;
         ...
         var_1741 = false;
         var_3157 = param1.roomId;
         var_1637.add(_loc3_,_loc2_);
         return _loc2_;
      }
      
      public function get chatContainer() : class_3207
      {
      ...
      {
         var _loc2_:int = 0;
         var _loc3_:RoomDesktop = var_1637.remove(param1) as RoomDesktop;
         if(_loc3_ != null)
         {
      ...
      {
         return var_1637.getValue(param1) as RoomDesktop;
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < var_1637.length)
         {
            _loc2_ = var_1637.getWithIndex(_loc3_) as RoomDesktop;
            if(_loc2_ != null)
            {
               _loc2_.update();
            }
      ...
      {
         var _loc2_:RoomDesktop = var_1637.getValue(getRoomIdentifier(_roomEngine.activeRoomId));
         if(_loc2_ != null)
         {
      ...
      public function showGamePlayerName(param1:int, param2:String, param3:uint, param4:int) : void
      {
         ...
         if((_loc5_ = var_1637.getValue(getRoomIdentifier(_roomEngine.activeRoomId))) != null)
         {
      ...
      public function get friendBarView() : class_3203
      {
