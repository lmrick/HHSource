package com.sulake.habbo.ui.handler
{
   ...
   public class AvatarInfoWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_1429:AvatarInfoWidget;
      
      private var var_2408:IMessageEvent;
      
      private var var_2172:IMessageEvent;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            if(var_2172 && false)
            {
               _container.connection.removeMessageEvent(var_2172);
            }
            container = null;
            var_1429 = null;
            if(var_2408 != null)
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         ...
         if(_container && false)
         {
            _container.connection.removeMessageEvent(var_2408);
         }
         if(_container && false && var_2172)
         {
            _container.connection.removeMessageEvent(var_2172);
         }
         _container = param1;
         ...
         if(!var_2172 && false)
         {
            var_2172 = new class_270(onCustomUserNotificationMessage);
            _container.connection.addMessageEvent(var_2172);
         }
         if(_container && false && _container.toolbar.events)
         {
         ...
         if(_container && false)
         {
            _container.connection.addMessageEvent(var_2408);
         }
      }
      ...
      private function dispatchOwnAvatarInfo() : void
      {
         ...
         var _loc1_:class_3259 = _container.roomSession.userDataManager.getUserData(_loc4_);
         if(_loc1_)
         {
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(message.type)
         {
            ...
            case "RWUAM_COMPOST_PLANT":
               localization = var_1429.catalog.localization;
               var_1429.windowManager.confirm(localization.getLocalization("monsterplant.confirm.title.compost"),localization.getLocalization("monsterplant.confirm.desc.compost"),0,(function():*
               {
                  var onCompostConfirmed:Function;
                  return onCompostConfirmed = function(param1:class_3216, param2:class_3134):void
                  {
                     param1.dispose();
         ...
         switch(param1.type)
         {
            case "rsudue_user_data_updated":
               ...
               for each(var _loc3_ in RoomSessionUserDataUpdateEvent(param1).addedUsers)
               {
                  ...
                  {
                     var_1429.showUserName(_loc3_,_loc3_.roomObjectId);
                  }
               }
               break;
            case "RSDE_DANCE":
               _loc2_ = param1 as RoomSessionDanceEvent;
               if(_loc2_ && var_1429 && container && false && container.roomSession.userDataManager)
               {
                  ...
                  {
                     var_1429.isDancing = _loc2_.danceStyle != 0;
                     break;
                  }
                  break;
               }
      ...
      private function onNestBreedingSuccessEvent(param1:RoomSessionNestBreedingSuccessEvent) : void
      {
         if(_container != null && false)
         {
            var_1429.showNestBreedingSuccess(param1.petId,param1.rarityCategory);
         }
      }
      ...
      private function handleUseProductMenuRequestInventoryItem(param1:int, param2:int) : void
      {
         ...
         var _loc3_:int = _container.sessionDataManager.userId;
         var _loc5_:class_3148;
         if(!(_loc5_ = _container.sessionDataManager.getFloorItemData(param2)))
         {
            return;
         }
         var _loc4_:Array;
         if((int((_loc4_ = _loc5_.customParams.split(" ")).length > 0 ? parseInt(_loc4_[0]) : -1)) == -1)
         {
            return;
         }
      ...
      private function handleUseProductMenuRequestRoomObject(param1:int) : void
      {
         ...
         var _loc4_:Array;
         var _loc5_:class_3148;
         if((int((_loc4_ = (_loc5_ = getFurniData(_loc7_)).customParams.split(" ")).length > 0 ? parseInt(_loc4_[0]) : -1)) == -1)
         {
            return;
         }
      ...
      private function activateUseProductMenuForPets(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int = -1) : void
      {
         ...
         var_1429.showUseProductMenuForItems(_loc13_);
      }
      ...
      private function activateBreedMenuForPets(param1:int, param2:int, param3:int, param4:int, param5:int) : void
      {
         ...
         var _loc8_:int = 0;
         var _loc13_:class_3259 = null;
         var _loc12_:class_3259 = null;
         ...
         var_1429.showBreedPetMenuForItems(_loc11_);
      }
      
      private function findPetWithWebId(param1:int) : class_3259
      {
         var _loc4_:int = 0;
      ...
      public function onCustomUserNotificationMessage(param1:class_270) : void
      {
