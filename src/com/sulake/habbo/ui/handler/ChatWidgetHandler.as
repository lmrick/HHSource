package com.sulake.habbo.ui.handler
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, class_1870, class_3158
   {
      ...
      private var _avatarImageCache:class_24 = null;
      
      private var _petImageCache:class_24 = null;
      
      private var _avatarColorCache:class_24 = null;
      
      private var _petImageIdToFigureString:class_24 = null;
      
      private var var_2354:Array;
      
      private var _connection:IConnection = null;
      
      private var var_2806:Number = 0;
      
      private var var_2197:Point = null;
      
      private var var_2123:Vector3d;
      
      private var var_1429:RoomChatWidget;
      
      public function ChatWidgetHandler()
      {
         var_2354 = [];
         var_2123 = new Vector3d();
         super();
      ...
      public function dispose() : void
      {
         ...
         for each(var _loc2_ in var_2354)
         {
            if(_loc2_ != null)
            {
               _loc2_.dispose();
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         var _loc31_:class_3259 = null;
         var _loc9_:String = null;
         if(false && !_container.freeFlowChat.isDisabledInPreferences)
         {
            return;
         }
         ...
         if(_container != null && false && _loc35_ != null)
         {
      ...
      {
         var_1429.addChatMessage(param1.message,param1.name,param1.locX,getUserImage(param1.figure),param1.color,param1.notify);
      }
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if((_loc6_ = _container.roomEngine.getRoomCanvasGeometry(_loc9_,_loc2_) as RoomGeometry) != null)
         {
            ...
            if(var_2197 == null)
            {
               ...
               var_2123.y = 0;
               var_2123.z = 0;
               var_2197 = _loc6_.getScreenPoint(var_2123);
               var_2806 = _loc6_.scale - 10;
            }
            _loc7_ = "";
            _loc8_ = null;
            var_2123.x = 0;
            var_2123.y = 0;
            var_2123.z = 0;
            _loc1_ = _loc6_.getScreenPoint(var_2123);
            if(_loc1_ != null)
            {
               ...
               if(_loc1_.x != var_2197.x || _loc1_.y != var_2197.y)
               {
                  if((_loc5_ = PointMath.sub(_loc1_,PointMath.mul(var_2197,_loc3_))).x != 0 || _loc5_.y != 0)
                  {
