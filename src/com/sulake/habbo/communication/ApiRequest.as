package com.sulake.habbo.communication
{
   ...
   public class ApiRequest
   {
      ...
      private var var_79:com.sulake.habbo.communication.class_45;
      
      private var var_191:URLRequest;
      ...
      public function makeRequest(param1:com.sulake.habbo.communication.class_45, param2:URLRequest) : void
      {
         param2.method = var_100;
         var_191 = param2;
         var_79 = param1;
         ...
         if(var_79)
         {
            ...
            try
            {
               ...
               if(_currentStatus >= 400 || _loc6_ && _loc3_.error != null)
               {
                  ...
                  var_79.apiError(_uri,_currentStatus,_loc6_ ? _loc3_.error : "",_loc3_,_loc7_);
               }
               else
               {
                  var_79.apiResponse(_uri,_loc3_);
               }
            }
            catch(e:Error)
            {
               ...
               var_79.apiRawResponse(_uri,_loc4_.data);
            }
         }
      }
      ...
      private function securityErrorHandler(param1:SecurityErrorEvent) : void
      {
         ...
         if(var_79 != null)
         {
            var_79.apiError(_uri,-1,"securityError",null);
         }
      ...
      private function httpStatusHandler(param1:HTTPStatusEvent) : void
      {
         ...
         switch(param1.status)
         {
            ...
            case 403:
               break;
            case 404:
               class_14.log("[ApiRequest - 404] httpStatusHandler: Resource does not exist. " + _uri,var_100,var_191.url);
               break;
            case 409:
               class_14.log("[ApiRequest - 409] httpStatusHandler: Conflict. " + _uri,var_100,var_191.url,_loc2_);
               break;
            case 500:
               class_14.log("[ApiRequest - 500] httpStatusHandler: Internal server error. " + _uri,var_100,_loc2_);
               break;
            default:
               class_14.log("[ApiRequest - " + param1.status + "] httpStatusHandler: undhandled. " + _uri,var_100,var_191.url);
         }
      }
      ...
      private function ioErrorHandler(param1:IOErrorEvent) : void
      {
         ...
         if(var_79 != null)
         {
            ...
            var_79.apiError(_uri,-2,"ioError",_loc3_,_loc4_);
         }
      }
   }
}
