package com.sulake.habbo.communication.messages.outgoing.camera
{
   ...
   import package_138.JsonMaskDrawingData;
   import package_138.JsonPlaneDrawingData;
   import package_138.JsonPoint;
   import package_138.JsonTextureColumnData;
   
   public class class_688 implements IMessageComposer
   {
      ...
      public function class_688(param1:Array, param2:String, param3:String, param4:int, param5:int)
      {
         var_45 = [];
         super();
         this.var_1365 = getRoomPlanesDataArray(param1);
      ...
      public function compressData() : void
      {
         ...
         var roomPlanesDataJsonObj:String = JSON.stringify(var_1365,function(param1:Object, param2:Object):*
         {
         ...
         var dataStrJsonObj:String = planesString() + roomPlanesDataJsonObj + spritesString() + var_1399 + modifiersString() + var_1384 + filtersString() + var_1386 + roomIdString() + roomId;
         if(zoomLevel != 1)
         {
