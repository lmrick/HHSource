package package_59
{
   ...
   public class class_253 implements IMessageComposer, class_13
   {
      ...
      public function class_253(param1:int, param2:String, param3:int, param4:int, param5:Boolean, param6:int)
      {
         var_20 = [];
         super();
