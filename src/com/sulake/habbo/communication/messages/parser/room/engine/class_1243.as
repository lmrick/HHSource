package package_154
{
   ...
   public class class_1243 implements IMessageParser
   {
      ...
      public function getUserUpdateData(param1:int) : class_1640
      {
         ...
         while(_loc22_ < _loc21_)
         {
            ...
            while(_loc23_ < _loc12_.length)
            {
               ...
               if(_loc26_ != "")
               {
                  ...
                  _loc30_.push(new class_1601(_loc26_,_loc17_));
               }
               _loc23_++;
            }
            _loc4_ = new class_1640(_loc15_,_loc27_,_loc28_,_loc29_,_loc13_,_loc7_,_loc16_,_loc20_,_loc19_,_loc18_,_loc11_,_loc10_,_loc30_,_loc8_);
            _users.push(_loc4_);
            _loc22_++;
         }
         return true;
