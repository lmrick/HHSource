package package_154
{
   ...
   public class class_1250 implements IMessageParser
   {
       
      
      private var _users:Array;
      
      public function class_1250()
      {
         _users = [];
         super();
      }
      ...
      public function getUser(param1:int) : class_1562
      {
         if(param1 < 0 || param1 >= getUserCount())
         {
            return null;
         }
         var _loc2_:class_1562 = _users[param1] as class_1562;
         if(_loc2_ != null)
         {
            _loc2_.setReadOnly();
         }
      ...
      public function parse(param1:IMessageDataWrapper) : Boolean
      {
         ...
         while(_loc7_ < _loc5_)
         {
            ...
            (_loc16_ = new class_1562(_loc18_)).dir = _loc11_;
            _loc16_.name = _loc8_;
      ...
      private function convertSwimFigure(param1:String, param2:String, param3:String) : String
      {
         ...
         var _loc18_:* = ["238,238,238","250,56,49","253,146,160","42,199,210","53,51,44","239,255,146","198,255,152","255,146,90","157,89,126","182,243,255","109,255,51","51,120,201","255,182,49","223,161,233","249,251,50","202,175,143","197,198,197","71,98,61","138,131,97","255,140,51","84,198,39","30,108,153","152,79,136","119,200,255","255,192,142","60,75,135","124,44,71","215,255,227","143,63,28","255,99,147","31,155,121","253,255,51"];
         var _loc19_:Array;
