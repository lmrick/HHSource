package com.sulake.habbo.window.theme
{
   ...
   public class ThemeManager implements IThemeManager
   {
      ...
      private static const const_1001:int = 100;
       
      
      private var var_1889:Dictionary;
      ...
      public function ThemeManager(param1:SkinContainer)
      {
         ...
         _loc5_.addEnumeration("pivot_point",PivotPoint.PIVOT_NAMES[0],class_3351.PIVOT_POINT_RANGE);
         ...
         _loc5_.addEnumeration("text_style","regular",class_3388.getStyleNameArrayRef());
         ...
         _loc5_.addEnumeration("widget_type","",class_3245.WIDGET_TYPES);
         ...
         var_1889["None"] = new Theme("None",false,0,4294967295,_loc5_);
         var _loc4_:int = 0;
         while(var_2002.skinRendererExists(1,_loc4_))
         {
            _loc4_++;
         }
         var_1889["Icon"] = new Theme("Icon",false,0,_loc4_,_loc5_);
         var _loc2_:int = 0;
         while(var_2002.skinRendererExists(30,_loc2_) && _loc2_ < 100)
         {
            _loc2_++;
         }
         var_1889["Legacy border"] = new Theme("Legacy border",false,0,_loc2_,_loc5_);
         var_1889["Volter"] = new Theme("Volter",true,0,3,_loc5_.clone());
         _loc3_ = _loc5_.clone();
         _loc3_.addEnumeration("antialias_type","advanced",["normal","advanced"]);
         _loc3_.addEnumeration("text_style","u_regular",class_3388.getStyleNameArrayRef());
         var_1889["Ubuntu"] = new Theme("Ubuntu",true,3,5,_loc3_);
         _loc3_ = _loc5_.clone();
         _loc3_.addEnumeration("antialias_type","advanced",["normal","advanced"]);
         _loc5_.addHex("etching_color",3003121663);
         _loc3_.addEnumeration("text_style","il_regular",class_3388.getStyleNameArrayRef());
         var_1889["Illumina Light"] = new Theme("Illumina Light",true,100,100,_loc3_);
         _loc3_ = _loc3_.clone();
         _loc5_.addEnumeration("illumina_border:border_style","illumina_dark",IlluminaBorderWidget.BORDER_STYLES);
         var_1889["Illumina Dark"] = new Theme("Illumina Dark",true,200,100,_loc3_);
      }
      ...
      public function getStyle(param1:String, param2:uint, param3:String) : uint
      {
         ...
         var _loc5_:Theme;
         if((_loc5_ = var_1889[param1]) == null)
         {
            return 0;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc5_.styleCount)
         {
            ...
            if(param3 == var_2002.getIntentByTypeAndStyle(param2,_loc6_))
            {
               return _loc6_;
            }
            _loc4_++;
      ...
      {
         var _loc4_:String = var_2002.getIntentByTypeAndStyle(param1,param2);
         if(param1 == 1)
         {
            return {
               "theme":"Icon",
         ...
         for each(var _loc3_ in var_1889)
         {
      ...
      public function getIntents(param1:uint, param2:String, param3:uint) : Array
      {
         ...
         if(param2 != "None")
         {
            _loc6_ = var_1889[param2];
            _loc5_ = 0;
            while(_loc5_ < _loc6_.styleCount)
            {
               if((_loc7_ = var_2002.getIntentByTypeAndStyle(param1,_loc6_.baseStyle + _loc5_)) != null)
               {
                  _loc4_.push(_loc7_);
               }
               _loc5_++;
      ...
      public function getPropertyDefaults(param1:uint) : class_3302
      {
