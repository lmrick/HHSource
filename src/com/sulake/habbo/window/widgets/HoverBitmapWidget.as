package com.sulake.habbo.window.widgets
{
   ...
   public class HoverBitmapWidget implements class_3325
   {
      
      public static const TYPE:String = "hover_bitmap";
      
      private static const const_594:String = "hover_bitmap:hover_asset";
      ...
      public function HoverBitmapWidget(param1:class_3217, param2:HabboWindowManagerComponent)
      {
         super();
         var_1547 = param1;
         ...
         var_1547.rootWindow = _bitmap;
         _bitmap.width = var_1547.width;
         _bitmap.height = var_1547.height;
         _bitmap.invalidate();
      }
