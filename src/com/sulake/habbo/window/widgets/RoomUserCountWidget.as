package com.sulake.habbo.window.widgets
{
   ...
   public class RoomUserCountWidget implements IRoomUserCountWidget
   {
      ...
      public function RoomUserCountWidget(param1:class_3217, param2:HabboWindowManagerComponent)
      {
         super();
         var_1547 = param1;
         _windowManager = param2;
         var_464 = _windowManager.buildFromXML(_windowManager.assets.getAssetByName("room_user_count_xml").content as XML) as class_3151;
