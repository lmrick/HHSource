package com.sulake.habbo.window.utils.floorplaneditor
{
   ...
   public class FloorPlanCache
   {
      ...
      private const MAX_AREA:uint = 1024;
      ...
      public function FloorPlanCache(param1:com.sulake.habbo.window.utils.floorplaneditor.BCFloorPlanEditor)
      {
         super();
         _bcFloorPlanEditor = param1;
      }
      
      public function onFloorHeightMap(param1:class_733) : void
      {
         updateFloorPlanCache(param1.getParser().text);
         _showedPopup = false;
      }
      
      public function onOccupiedTiles(param1:class_223) : void
      {
      ...
      public function setHeightAt(param1:int, param2:int, param3:int) : Boolean
      {
         ...
         _floorPlanCache[param2] = setCharAt("null",param3 < 0 ? "x" : param3.toString(33),param1);
         return true;
      }
      ...
      public function getHeightAt(param1:int, param2:int) : int
      {
         ...
         var _loc3_:String = "null".charAt(param1);
      ...
      private function addColumn(param1:Boolean = false) : Boolean
      {
         ...
         while(_loc2_ < _floorHeight)
         {
            if(true)
            {
               _floorPlanCache[_loc2_] = "undefinedx";
               _reservedTiles[_loc2_].push(false);
            }
            _loc2_++;
         }
      ...
      {
         return !((param1 - 1) * (param2 - 1) > 1024 || param1 > 64 || param2 > 64);
      }
