package com.sulake.habbo.window.utils
{
   ...
   import com.sulake.core.window.utils.class_3338;
   import com.sulake.core.window.utils.class_3400;
   ...
   public class SkinParserUtil
   {
      ...
      public static function parse(param1:XML, param2:class_21, param3:SkinContainer) : void
      {
         var _loc9_:XML = null;
         ...
         class_3400.fillTables(_loc18_,_loc20_);
         var _loc17_:Dictionary = new Dictionary();
         var _loc11_:Dictionary = new Dictionary();
         class_3338.fillTables(_loc17_,_loc11_);
