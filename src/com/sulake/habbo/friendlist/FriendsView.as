package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, class_3150
   {
      ...
      private var _minimailButton:class_3258;
      
      private var _homeButton:class_3258;
      
      private var _inviteButton:class_3258;
      
      private var _removeButton:class_3258;
      
      private var var_19:IItemListWindow;
      
      private var var_2240:com.sulake.habbo.friendlist.RelationshipStatusSelector;
      ...
      {
         _minimailButton = initButton("open_minimail",onMinimailButtonClick,param1);
         _homeButton = initButton("open_homepage",onHomeButtonClick,param1);
         _inviteButton = initButton("room_invite",onInviteButtonClick,param1);
         _removeButton = initButton("remove_friend",onRemoveButtonClick,param1);
         refreshButtons();
      }
      ...
      public function refreshList() : void
      {
         ...
         if(!var_2240)
         {
            var_2240 = new com.sulake.habbo.friendlist.RelationshipStatusSelector(_friendList);
         }
         var_2240.disappear();
      ...
      private function initButton(param1:String, param2:Function, param3:class_3151) : class_3258
      {
         var _loc4_:class_3258;
         (_loc4_ = class_3258(param3.findChildByName("button_" + param1))).procedure = param2;
         var _loc5_:class_3282;
         (_loc5_ = class_3282(_loc4_.findChildByName("icon"))).bitmap = _friendList.getButtonImage(param1);
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         if((_loc5_ = var_19.getListItemAt(param2) as class_3151) == null)
         {
            if(!param1)
            {
               return true;
            }
            (_loc5_ = class_3151(_friendList.getXmlWindow("friend_entry"))).findChildByName("user_info_region").procedure = onUserInfo;
      ...
      private function refreshCatIcon(param1:class_3151, param2:String, param3:Boolean, param4:int, param5:int) : void
      {
      ...
      private function refreshFigure(param1:class_3151, param2:Friend) : void
      {
         ...
         if(!(_loc4_ = param1.getChildByName("face") as class_3282))
         {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(_minimailButton,isEnableMinimailButton(_loc1_));
         setEnabled(_homeButton,isEnableHomeButton(_loc1_));
         setEnabled(_inviteButton,isEnableInviteButton(_loc1_));
         setEnabled(_removeButton,isEnableRemoveButton(_loc1_));
      }
      ...
      private function onCategoryClick(param1:class_3134, param2:class_3127) : void
      {
      ...
      private function onFriendClick(param1:class_3134, param2:class_3127) : void
      {
      ...
      private function onFollowButtonClick(param1:class_3134, param2:class_3127) : void
      {
         ...
         _friendList.send(new class_430(param2.id));
         _friendList.send(new class_898("Navigation","Friend List","go.friendlist"));
      }
      
      private function onRelationshipStatusRegion(param1:class_3134, param2:class_3127) : void
      {
         if(param2 == null)
         {
            return;
         ...
         if(param1.type == "WME_CLICK")
         {
            var_2240.friendId = param2.id;
            var_2240.appearAt(param2,_friendList.view.mainWindow);
         }
      }
      
      private function onUserInfo(param1:class_3134, param2:class_3127) : void
      {
         _friendList.view.showInfo(param1,"${infostand.profile.link.tooltip}");
         if(param1.type == "WME_OVER")
         {
            ExtendedProfileIcon.setUserInfoState(true,class_3151(param2));
         }
         else if(param1.type == "WME_OUT")
         {
            ExtendedProfileIcon.setUserInfoState(false,class_3151(param2));
         }
         else if(param1.type == "WME_CLICK")
         {
            _friendList.trackGoogle("extendedProfile","friendList_friendsView");
            _friendList.send(new class_313(param2.parent.id));
         }
      }
      
      private function onMinimailButtonClick(param1:class_3134, param2:class_3127) : void
      {
         var _loc5_:int = 0;
      ...
      private function onHomeButtonClick(param1:class_3134, param2:class_3127) : void
      {
      ...
      private function onInviteButtonClick(param1:class_3134, param2:class_3127) : void
      {
      ...
      private function onRemoveButtonClick(param1:class_3134, param2:class_3127) : void
      {
      ...
      {
         var _loc3_:int = 0;
         var _loc4_:class_3151 = class_3151(param1.view.findChildByName("pager"));
      ...
      private function refreshPageLink(param1:class_3151, param2:int, param3:int, param4:Boolean) : void
      {
      ...
      private function onPageLinkClick(param1:class_3134, param2:class_3127) : void
      {
         if(param1.type != "WME_CLICK")
         {
            return;
