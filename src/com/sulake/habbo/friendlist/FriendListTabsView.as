package com.sulake.habbo.friendlist
{
   ...
   public class FriendListTabsView
   {
      ...
      public function FriendListTabsView(param1:com.sulake.habbo.friendlist.HabboFriendList)
      {
         super();
         _friendList = param1;
      }
      ...
      public function refresh(param1:String) : void
      {
         ...
         {
            _loc3_ = _content.getChildByName("flt_" + _loc5_.id) as class_3151;
      ...
      private function refreshTabContent(param1:FriendListTab, param2:class_3151) : void
      {
         if(param1.selected)
         {
            if(param1.view == null)
            {
               param1.view = this.getTabContent(param1) as class_3151;
            }
      ...
      private function refreshHeader(param1:FriendListTab, param2:class_3151) : int
      {
         var _loc3_:class_3151 = param2.getChildByName("header") as class_3151;
         _loc3_.width = _friendList.tabs.tabContentWidth;
      ...
      private function showBgImage(param1:class_3151, param2:Boolean, param3:String) : void
      {
         class_14.log("REFRESHING BG IMAGE: " + param2 + ", " + param3);
         var _loc4_:class_3282 = param1.getChildByName(param3) as class_3282;
         if(!param2)
         {
            if(_loc4_ != null)
            {
      ...
      private function refreshArrowIcon(param1:class_3151, param2:String, param3:Boolean, param4:int) : void
      {
         ...
         if(param3)
         {
            ...
            (_loc6_ = class_3127(param1.findChildByName(param2))).x = _loc5_.textWidth + param4;
         }
      }
      
      private function refreshTabText(param1:FriendListTab, param2:class_3151) : void
      {
      ...
      private function getTabContent(param1:FriendListTab) : class_3127
      {
         var _loc2_:class_3151 = class_3151(_friendList.getXmlWindow("tab_content"));
      ...
      private function refreshTabContentDims(param1:class_3151) : void
      {
         var _loc3_:class_3151 = param1.getChildByName("footer") as class_3151;
         var _loc6_:class_3151;
         var _loc8_:class_3127 = (_loc6_ = param1.getChildByName("list") as class_3151).getChildByName("scroller") as class_3127;
         var _loc9_:IItemListWindow = IItemListWindow(_loc6_.getChildByName("list_content"));
         var _loc7_:class_3127 = _loc6_.parent;
      ...
      private function refreshScrollBarVisibility(param1:class_3151) : void
      {
         var _loc6_:class_3151;
         var _loc7_:class_3127 = (_loc6_ = param1.getChildByName("list") as class_3151).getChildByName("scroller") as class_3127;
         ...
         var _loc5_:int;
         var _loc8_:int = (_loc5_ = _friendList.tabs.tabContentWidth - 10) - 22;
      ...
      private function getTabContentFooter(param1:FriendListTab) : class_3127
      {
         var _loc2_:class_3151 = class_3151(this._friendList.getXmlWindow(param1.footerName));
