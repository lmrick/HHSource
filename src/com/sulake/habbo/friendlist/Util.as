package com.sulake.habbo.friendlist
{
   ...
   public class Util
   {
      ...
      public static function getRightmostPoint(param1:class_3151) : int
      {
         var _loc2_:int = 0;
         var _loc4_:class_3127 = null;
         var _loc3_:int = 0;
      ...
      public static function print(param1:String, param2:class_3127) : void
      {
         var _loc3_:int = 0;
      ...
      public static function layoutChildrenInArea(param1:class_3151, param2:int, param3:int) : void
      {
         var _loc6_:int = 0;
